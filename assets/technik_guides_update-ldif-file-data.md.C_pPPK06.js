import{f as n,o as a,c as e,aq as p}from"./chunks/framework.CAfuRaXs.js";const b=JSON.parse('{"title":"Aktualisieren der embedded-LDAP User","description":"","frontmatter":{},"headers":[],"relativePath":"technik/guides/update-ldif-file-data.md","filePath":"technik/guides/update-ldif-file-data.md"}'),l={name:"technik/guides/update-ldif-file-data.md"};function i(r,s,c,t,o,d){return a(),e("div",null,[...s[0]||(s[0]=[p(`<h1 id="aktualisieren-der-embedded-ldap-user" tabindex="-1">Aktualisieren der embedded-LDAP User <a class="header-anchor" href="#aktualisieren-der-embedded-ldap-user" aria-label="Permalink to &quot;Aktualisieren der embedded-LDAP User&quot;">​</a></h1><h2 id="kontext" tabindex="-1">Kontext <a class="header-anchor" href="#kontext" aria-label="Permalink to &quot;Kontext&quot;">​</a></h2><p>Der <a href="/Wahllokalsystem/services/backend-services/auth-service/">Auth-Service</a> verwendet einen embedded LDAP-Server, wenn<br> keine LDAP-Verbindung konfiguriert ist. Die Daten dieses Servers werden über ein <a href="https://de.wikipedia.org/wiki/LDAP_Data_Interchange_Format" target="_blank" rel="noreferrer">LDIF</a>-File definiert. Wenn bei der Eingabe von Wahltermindaten neue Benutzerkonten erstellt werden, müssen diese im LDIF-File ergänzt werden.</p><h2 id="kurzbeschreibung-des-vorgehens" tabindex="-1">Kurzbeschreibung des Vorgehens <a class="header-anchor" href="#kurzbeschreibung-des-vorgehens" aria-label="Permalink to &quot;Kurzbeschreibung des Vorgehens&quot;">​</a></h2><p>Über das Skript <code>generateLdif.sh</code> im Ordner <code>stack/ldap</code> des Repositories kann eine LDIF-Datei erstellt werden. Als Input benötigt das Skript eine Datei, die zeilenweise die Benutzerkonten enthält. Nach dem Ausführen des Skriptes sind die neuen Benutzerkonten und deren Zuordnung zu einer Gruppe aus der erzeugten Datei zu kopieren und in das bestehende Skript zu integrieren. Danach kann man sich zusätzlich mit den generierten Konten einloggen.</p><h2 id="beschreibung-im-detail" tabindex="-1">Beschreibung im Detail <a class="header-anchor" href="#beschreibung-im-detail" aria-label="Permalink to &quot;Beschreibung im Detail&quot;">​</a></h2><h3 id="ausgangslage" tabindex="-1">Ausgangslage <a class="header-anchor" href="#ausgangslage" aria-label="Permalink to &quot;Ausgangslage&quot;">​</a></h3><p>Gehen wir davon aus, es gibt folgendes LDIF-File:</p><div class="language-text vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">text</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>dn: ou=groups,dc=springframework,dc=org</span></span>
