      ...
      [PATH_TECHNIK]: [
        ...
        { text: "Entwicklungsumgebung", link: `${PATH_TECHNIK}development/` },
        {
          ...
          items: [
            ...
            {
              text: "Tips und Tricks",
              link: `${PATH_GUIDES}tips-and-tricks.md`,
            },
          ],
        },
        {
          text: "Coding Conventions",
          link: `${PATH_CODING_CONVENTIONS}`,
          collapsed: true,
          items: [
            {
              text: "Naming Convention - Testing",
              link: `${PATH_CODING_CONVENTIONS}tests_naming`,
            },
            {
              text: "Naming Convention - Database",
              link: `${PATH_CODING_CONVENTIONS}db_naming`,
            },
          ],
        },
        {
      ...
      [PATH_SERVICES]: [
        {
          ...
          link: `${PATH_SERVICES}briefwahl-service/`,
        },
        {
        ...
        { text: "EAI-Service", link: `${PATH_SERVICES}eai-service/` },
        {
          ...
          link: `${PATH_SERVICES}basisdaten-service/`,
        },
        {
          text: "Monitoring-Service",
          link: `${PATH_SERVICES}monitoring-service/`,
        },
        {
          text: "Wahlvorstand-Service",
          link: `${PATH_SERVICES}wahlvorstand-service/`,
        },
        {
          text: "Ergebnismeldung-Service",
          link: `${PATH_SERVICES}ergebnismeldung-service/`,
        },
        { text: "Auth-Service", link: `${PATH_SERVICES}auth-service/` },
        {
          text: "Vorfälle und Vorkommnisse-Service",
          link: `${PATH_SERVICES}vorfaelleundvorkommnisse-service/`,
        },
