...
| u&lt;Kandidatordnungszahl> | Fügt 1 ungültige Stimme bei dem/der Kandidat\*in mit der `Ordnungszahl` hinzu | u101 |
| u&lt;Kandidatordnungszahl>+&lt;n> | Fügt `n` ungültige Stimmen bei dem/der Kandidat\*in mit der `Ordnungszahl` hinzu | u101+3 |
...
| &lt;Wahlvorschlagsnummer> | Kennzeichnet den Wahlvorschlag mit `Ordnungszahl` (auch Eingabe mit „00“ am Ende möglich) | 5, 500 |
| s&lt;Kandidatordnungszahl> | Streichung für den/die Kandidat\*in mit der `Ordnungszahl` | s501 |
| s&lt;untere>-&lt;obere> | Streichungen für alle Kandidat\*innen im Bereich der `Ordnungszahl` von `untere`–`obere` | s501-509 |
