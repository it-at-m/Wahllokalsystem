...
werden entsprechend markiert und mit einem oder mehreren `Beschlussgründen/Vormerkungsgründen` versehen.
...
`Beschlussgründe/Vormerkungsgründe` stellt einen `Beschlussvorschlag` dar, über welchen im Gremium abgestimmt wird.
