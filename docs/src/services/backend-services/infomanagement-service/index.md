...
| WAEHLERVERZEICHNIS_URL         | URL zum Wählerverzeichnis. Leer lassen, um Verknüpfung im WLS auszublenden.       |                                                                                                                                                                                                  |
...
| DSE_AKTIV                      | Soll die digitale Stimmzettelerfassung verwendet werden                           | true                                                                                                                                                                                             |  
