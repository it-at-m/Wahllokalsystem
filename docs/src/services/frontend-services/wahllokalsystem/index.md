...
[`vite-pwa-plugin`](https://vite-pwa-org.netlify.app/) ein ServiceWorker eingerichtet.

### Funktionsweise des SW

Nachdem der Service Worker erfolgreich registriert und installiert wurde, fängt er alle Api-Anfragen ab.
