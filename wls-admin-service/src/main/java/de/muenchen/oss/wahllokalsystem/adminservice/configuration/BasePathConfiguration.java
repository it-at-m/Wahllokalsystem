...
public class BasePathConfiguration {
  ...
  private final de.muenchen.oss.wahllokalsystem.adminservice.eai.basisdaten.ApiClient
      basisdatenApiClient;
  private final de.muenchen.oss.wahllokalsystem.adminservice.eai.infomanagement.ApiClient
      infomanagementApiClient;
  private final de.muenchen.oss.wahllokalsystem.adminservice.eai.ergebnismeldung.ApiClient
      ergebnismeldungApiClient;
