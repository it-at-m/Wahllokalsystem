...
public class WahlenController {
  ...
  @Operation(
      ...
      responses = {
        @ApiResponse(responseCode = "200", description = "Die Wahlen wurden erfolgreich gelesen."),
        @ApiResponse(
            responseCode = "204",
            description = "Es existieren keine Wahlen zu den entsprechenden Kriterien.",
            content = {@Content()})
      })
  @GetMapping("/wahlen/{wahltagID}")
  public ResponseEntity<List<WahlDTO>> getWahlen(
  ...
  @Operation(
      ...
      responses = {
        @ApiResponse(
            responseCode = "200",
            description = "Die Wahlen wurden erfolgreich gespeichert.")
      })
  @PostMapping("/wahlen/{wahltagID}")
  public ResponseEntity<?> updateWahlen(
      @RequestBody final List<WahlDTO> wahlen, @PathVariable("wahltagID") final String wahltagID) {
