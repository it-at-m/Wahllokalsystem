...
public interface WahllokalBenutzerClient {
  ...
  /**
   * Generiert Wahllokalbenutzer zum angegebenen Wahltag. Für jeden Benutzer der angelegt werden
   * soll, muss eine WahllokalUserInfo im Body vorhanden sein. *
   *
   * @param wahltagID
   ...
   *     zurückgegeben.
   */
  String generateAndExportWahllokalBenutzer(
  ...
  /**
   * @param wahltagID
   * @return Liefert einen CSV-String der alle Wahllokalbenutzernamen zum angegebenen Wahltag
   *     enthält
   */
