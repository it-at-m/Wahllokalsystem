...
class WahllokalBenutzerClientImplTest {
  ...
  @Mock WahllokalBenutzerControllerApi wahllokalBenutzerControllerApi;

  @Mock ExceptionFactory exceptionFactory;

  @Mock WahllokalBenutzerClientMapper wahllokalBenutzerClientMapper;

  @InjectMocks WahllokalBenutzerClientImpl unitUnderTest;
  ...
  class GenerateAndExportWahllokalBenutzer {
    ...
    void should_verifyCreateAndExportWahllokalBenutzer_when_wahllokalBenutzerModelsIsGiven() {
      ...
      Mockito.verify(wahllokalBenutzerControllerApi)
          .createAndExportWahllokalBenutzer("wahltagID", mockedListOfWahllokalUserInfoDTOs);
    }
    ...
    void should_rethrowWlsException_when_wlsExceptionIsThrownFromWahllokalBenutzerControllerApi() {
      ...
      val mockedWlsException =
          TechnischeWlsException.withCode("000")
              .buildWithMessage("communication with WahllokalBenutzerControllerApi api failed");

      Mockito.doThrow(mockedWlsException)
          .when(wahllokalBenutzerControllerApi)
          .createAndExportWahllokalBenutzer("wahltagID", mockedListOfWahllokalUserInfoDTOs);

      Assertions.assertThatException()
          .isThrownBy(
              () ->
                  unitUnderTest.generateAndExportWahllokalBenutzer(
                      "wahltagID", listOfWahllokalbenutzerModels))
          .isSameAs(mockedWlsException);
    }

    @Test
    void
        should_throwTechnischeWlsException_when_nonWlsExceptionIsThrownFromWahllokalBenutzerControllerApi() {
      val listOfWahllokalbenutzerModels = getListOfWahlLokalBenutzerModels();
      val mockedListOfWahllokalUserInfoDTOs = getListOfWahlLokalUserInfoDTO();
      Mockito.when(wahllokalBenutzerClientMapper.toDTO(listOfWahllokalbenutzerModels))
          .thenReturn(mockedListOfWahllokalUserInfoDTOs);
    ...
    void should_returnExportedUsers_when_generateAndExportSucceeds() {
      ...
      Mockito.when(
              wahllokalBenutzerControllerApi.createAndExportWahllokalBenutzer(
                  "wahltagID", mockedListOfWahllokalUserInfoDTOs))
  ...
  class ExportWahllokalBenutzer {
    ...
    void should_rethrowWlsException_when_wlsExceptionIsThrownFromWahllokalBenutzerControllerApi() {
      ...
      Mockito.doThrow(mockedWlsException)
          .when(wahllokalBenutzerControllerApi)
          .exportWahllokalBenutzer("wahltagID");
  ...
  class DeleteWahllokalBenutzer {
    ...
    void should_rethrowWlsException_when_wlsExceptionIsThrownFromWahllokalBenutzerControllerApi() {
      ...
      Mockito.doThrow(mockedWlsException)
          .when(wahllokalBenutzerControllerApi)
          .deleteWahllokalBenutzer("wahltagID");
