...
class WahlenClientImplTest {
  ...
  @Mock WahlenClientMapper wahlenClientMapper;

  @InjectMocks WahlenClientImpl unitUnderTest;
  ...
  class ResetWahlen {
    ...
    void should_throwTechnischeWlsException_when_wlsExceptionIsThrownFromWahlenApi() {
      ...
      Assertions.assertThatException()
          .isThrownBy(() -> unitUnderTest.resetWahlen())
  ...
  class GetWahlen {
    ...
    void should_returnWahlen_when_wahlenExists() {
      ...
      Mockito.when(wahlenClientMapper.toModelList(mockedWahlDtoList))
          .thenReturn(mockedWahlModelList);
    ...
    void should_rethrowWlsException_when_wlsExceptionIsThrownFromWahlenApi() {
      ...
      Assertions.assertThatException()
          .isThrownBy(() -> unitUnderTest.getWahlen(wahlID))
          .isSameAs(mockedWlsException);
    }
  ...
  class PostWahlen {
    ...
    void should_rethrowWlsException_when_wlsExceptionIsThrownFromWahlenApi() {
      ...
      Assertions.assertThatException()
          .isThrownBy(() -> unitUnderTest.postWahlen(wahlID, null))
          .isSameAs(mockedWlsException);
    }
