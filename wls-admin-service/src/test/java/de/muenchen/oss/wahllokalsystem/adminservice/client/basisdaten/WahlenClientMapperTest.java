...
class WahlenClientMapperTest {
      ...
      val dtosToMap =
          List.of(
              new WahlDTO()
                  ...
                  .wahltag(nowDate)
                  .wahlart(WahlDTO.WahlartEnum.BAW)
              ...
              new WahlDTO()
                  ...
                  .waehlerverzeichnisNummer(1L)
                  .wahltag(nowDate)
                  .wahlart(WahlDTO.WahlartEnum.LTW)
                  .farbe(new FarbeDTO().r(7L).g(8L).b(9L))
                  .nummer("3"));

      Assertions.assertThat(dtosToMap)
          .allSatisfy(wahl -> Assertions.assertThat(wahl).hasNoNullFieldsOrProperties());
  ...
  class ToDtoList {
    ...
    void should_mapToListOfDto_when_givenListOfModel() {
      ...
      Assertions.assertThat(modelsToMap)
          .allSatisfy(wahl -> Assertions.assertThat(wahl).hasNoNullFieldsOrProperties());
