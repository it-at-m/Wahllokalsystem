...
class KonfigurierterWahltagDTOMapperTest {
  ...
  class ToDTO {
    ...
    void should_mapToDtoWithEnumStatusAktiv_when_givenModelWithActiveTrue() {
      ...
      val konfigurierterWahltagModel =
          new KonfigurierterWahltagModel(dateNow, "wahltagID", true, "123");
      ...
      val expectedkonfigurierterWahltagDTO =
          new KonfigurierterWahltagDTO(LocalDate.now(), "wahltagID", WahltagStatusDTO.AKTIV, "123");
    ...
    void should_mapToDtoWithEnumStatusInaktiv_when_givenModelWithActiveFalse() {
      val dateNow = LocalDate.now();
      val konfigurierterWahltagModel =
          new KonfigurierterWahltagModel(dateNow, "wahltagID", false, "123");
      ...
      val expectedkonfigurierterWahltagDTO =
          new KonfigurierterWahltagDTO(
              LocalDate.now(), "wahltagID", WahltagStatusDTO.INAKTIV, "123");
  ...
  class ToModel {
    ...
    void should_mapToModelWithActiveTrue_when_givenDtoWithEnumStatusAktiv() {
      ...
      val expectedkonfigurierterWahltagModel =
          new KonfigurierterWahltagModel(LocalDate.now(), "wahltagID", true, "123");
    ...
    void should_mapToModelWithActiveFalse_when_givenDtoWithEnumStatusInaktiv() {
      ...
      val expectedkonfigurierterWahltagModel =
          new KonfigurierterWahltagModel(LocalDate.now(), "wahltagID", false, "123");
