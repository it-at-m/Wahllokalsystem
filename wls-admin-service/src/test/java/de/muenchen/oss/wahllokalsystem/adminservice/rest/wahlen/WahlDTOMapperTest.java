...
class WahlDTOMapperTest {
  ...
  private List<WahlDTO> createWahlDTOList() {
    val wahl1 =
        new WahlDTO(
            "wahlID1", "name1", 3L, 1L, LocalDate.now(), WahlartDTO.BAW, new FarbeDTO(1, 2, 3));
    val wahl2 =
        new WahlDTO(
            "wahlID2",
            "name2",
  ...
  private List<WahlModel> createWahlModelList() {
    val wahl1 =
        new WahlModel(
            "wahlID1", "name1", 3L, 1L, LocalDate.now(), WahlartModel.BAW, new FarbeModel(1, 2, 3));
    val wahl2 =
        new WahlModel(
            "wahlID2",
            "name2",
