 ...
 *
 * <p>This implementation was required to use our own AuthenticationFilter and display
 * authentication exceptions on the form. With the existing `FormLoginConfigurer`, it was not
 * possible to change the `AuthenticationFilter`
 */
@Component
class WlsFormLoginConfigurer<H extends HttpSecurityBuilder<H>>
    extends AbstractAuthenticationFilterConfigurer<
        H, WlsFormLoginConfigurer<H>, CustomUsernamePasswordAuthenticationFilter> {

  public WlsFormLoginConfigurer(
