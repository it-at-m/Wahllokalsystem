 ...
 * </p>
 */
@PreAuthorize("hasAuthority(T(de.muenchen.oss.wahllokalsystem.authservice.security.AuthoritiesEnum).WLS_AUTH_SERVICE_READ_THEENTITY.name())")
public interface TheEntityRepository extends CrudRepository<TheEntity, UUID> { //NOSONAR
    ...
    @PreAuthorize("hasAuthority(T(de.muenchen.oss.wahllokalsystem.authservice.security.AuthoritiesEnum).WLS_AUTH_SERVICE_WRITE_THEENTITY.name())")
    ...
    @PreAuthorize("hasAuthority(T(de.muenchen.oss.wahllokalsystem.authservice.security.AuthoritiesEnum).WLS_AUTH_SERVICE_DELETE_THEENTITY.name())")
