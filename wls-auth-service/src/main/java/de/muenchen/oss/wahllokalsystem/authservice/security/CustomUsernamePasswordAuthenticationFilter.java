...
public class CustomUsernamePasswordAuthenticationFilter
  ...
  public Authentication attemptAuthentication(
    ...
    if (userService.isLocked(username)) {
      ...
      if (loginAttempts.isPresent()
          && loginAttempts.get().lastModified() != null
      ...
      logUserCustom(
          "5", "benutzername=" + username + "|message=Der Benutzer ist gesperrt|", username);
    }
  ...
  public void successfulAuthentication(
    ...
    try {
      ...
      logUserCustom(
          ...
          "benutzername="
              + username
              + "|message=Der Benutzer hat sich erfolgreich am System angemeldet|",
          username);
  ...
  public void unsuccessfulAuthentication(
    ...
    if (userService.doesUserExist(username) && failed instanceof BadCredentialsException) {
      ...
      super.unsuccessfulAuthentication(
          request, response, new BadCredentialsException(loginErrorMessage));
    ...
    if (userService.doesUserExist(username)) {
      ...
      logUserCustom(
          "2", "benutzername=" + username + "|message=Unbekannter Benutzername|", username);
    }
  }
  ...
  private boolean isPenaltyOver(LocalDateTime lastLoginAttempt) {
    return lastLoginAttempt
        .plusMinutes(falscheLoginZeitstrafeInMinutes)
  ...
  private boolean hasRequiredAuthority(
      final UserDetails userDetails, final String requiredAuthority) {
