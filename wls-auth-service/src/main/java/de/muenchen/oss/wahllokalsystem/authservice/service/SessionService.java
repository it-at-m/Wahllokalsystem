                    ...
                    .forEach(
                        currSessionInfo -> {
                          ...
                          if (principal instanceof String principalString) {
                            ...
                            log.warn(
                                "Principal was not instance of expected datatypes, but is an Object of Class: {}.",
                                principal.getClass().getName());
                            try {
                              currSession.setUsername(
                                  (String)
                                      principal
                                          .getClass()
                              ...
                              log.warn(
                                  "Failed to retrieve username via reflection for principal class {}.",
                                  principal.getClass().getName(),
                                  e);
                            }
                          }
  ...
  public boolean killSession(String sessionId) {
    ...
    if (sessionInformation != null && !sessionInformation.isExpired()) {
      if (sessionInformation.getPrincipal() != null) {
        log.info(
            "Killing session with id: {} principal: {}",
            sessionId,
