...
VALUES ('48d5545c-7338-41a0-9d90-54becc84d473', 'admingui', TIMESTAMP '2025-04-16 08:20:00.000000',
        '{bcrypt}$2a$10$zCvSE.rK0Hb6MqkeKHwHzOMhCB5FW12XHOWEyRgiwDsj6i2CfvDj2', null, 'admin-gui-wahllokal',
        'client_secret_basic', 'refresh_token,client_credentials,authorization_code',
        'http://127.0.0.1:8080/oauth2/authorized,http://localhost:8084/login/oauth2/code/sso',
