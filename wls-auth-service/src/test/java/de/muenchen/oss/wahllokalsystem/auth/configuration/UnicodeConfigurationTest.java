 ...
 */
package de.muenchen.oss.wahllokalsystem.auth.configuration;

import static de.muenchen.oss.wahllokalsystem.auth.TestConstants.SPRING_NO_SECURITY_PROFILE;
import static de.muenchen.oss.wahllokalsystem.auth.TestConstants.SPRING_TEST_PROFILE;
import static de.muenchen.oss.wahllokalsystem.auth.TestConstants.TheEntityDto;
import static org.junit.jupiter.api.Assertions.assertEquals;

import de.muenchen.oss.wahllokalsystem.auth.MicroServiceApplication;
import de.muenchen.oss.wahllokalsystem.auth.domain.TheEntity;
import de.muenchen.oss.wahllokalsystem.auth.rest.TheEntityRepository;
import java.net.URI;
