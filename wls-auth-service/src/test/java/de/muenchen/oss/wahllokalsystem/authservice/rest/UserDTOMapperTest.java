...
class UserDTOMapperTest {
  ...
  class ToModel {
    ...
    void should_returnModel_when_givenDTO() {
      ...
      val user1 =
          new WahllokalUserInfoDTO(
              wahlbezirknummer, wahltag, wahlbezirkID, wahlbezirksart, wbidWahlnummer);

      val result = unitUnderTest.toModel(wahltagID, List.of(user1));

      val expectedResult =
          new UsersOfWahltagModel(
              wahltagID,
              List.of(
    ...
    void should_returnModelEnumValueWithSameValueAsDTO_when_givenAnyWahlbezirkArtDTOEnumValue(
        final WahlbezirksartDTO wahlbezirksartDTO) {
          ...
          new UsersOfWahltagModel(
              ...
              List.of(
                  new WahllokalUserInfoModel(
                      ...
                      null,
                      null,
                      WahlbezirksartModel.valueOf(wahlbezirksartDTO.name()),
                      null)));
      Assertions.assertThat(result).isEqualTo(expectedResult);
    }
  }
