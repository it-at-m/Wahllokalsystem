...
class CustomUsernamePasswordAuthenticationFilterTest {
  ...
  private static final String SESSION_ATTRIBUTE_SPRING_SECURITY_SAVED_REQUEST =
  ...
  class AttemptAuthentication {
    ...
    void should_returnAuthenticationOfAppClient_when_userIsNotLockedAndIsAllowedToLogin(
      ...
      val result =
          unitUnderTest.attemptAuthentication(httpServletRequest, new MockHttpServletResponse());
    ...
    @Test
    void
        should_throwBadCredentialsExceptionAndUpdateLoginAttempts_when_userIsNotAllowedToLoginCauseOfMissingSavedRequestInSession() {
      val username = "username";
      val password = "password";
      val httpServletRequest =
          createAuthenticationRequest(username, password, WAHLLOKAL_GUI_CLIENT_ID);
      httpServletRequest
          .getSession()
          .setAttribute(SESSION_ATTRIBUTE_SPRING_SECURITY_SAVED_REQUEST, null);
    ...
    void
        should_throwBadCredentialsExceptionAndUpdateLoginAttempts_when_userIsNotAllowedToLoginCauseOfIllegalRedirectUrl(
            final String illegalUrl) {
      val username = "username";
      val password = "password";
    ...
    @ValueSource(
        strings = {
          ...
          ADMIN_GUI_CLIENT_ID,
          "someUndefinedValueContainedInRedirectUrl"
        })
    void
        should_throwBadCredentialsExceptionAndUpdateLoginAttempts_when_userIsNotAllowedToLoginCauseOfMissingAuthorityForRedirectUrl(
  ...
  class SuccessfulAuthentication {
    ...
    void should_resetFailAttempts_when_successfullyAuthenticates() throws Exception {
      ...
      unitUnderTest.successfulAuthentication(
          httpServletRequest,
      ...
      Mockito.verify(unitUnderTest)
          .successfulAuthentication(
              same(httpServletRequest), any(), same(mockedFilterChain), same(mockedAuthentication));
    }

    @Test
    void should_uncessfulAuthenticate_when_loginInterceptorThrewAuthenticationException()
        throws Exception {
      val username = "username";
      val password = "password";
      val httpServletRequest = createAuthenticationRequest(username, password, "");
      ...
      Mockito.doThrow(mockedValidationException)
          .when(loginInterceptor)
          .validateLoginOrThrow(mockedLdapUserDetails);
      ...
      Mockito.verify(unitUnderTest)
          .unsuccessfulAuthentication(
              same(httpServletRequest), any(), same(mockedValidationException));
    }
  ...
  class UnsuccessfulAuthentication {
    ...
    @Test
    void should_resetFailAttempts_when_userExistsAndExceptionWasBadCredentialsException()
        throws Exception {
      val username = "username";
      ...
      unitUnderTest.unsuccessfulAuthentication(
          httpServletRequest, new MockHttpServletResponse(), new BadCredentialsException(""));
    ...
    void
        should_callSuperUnsuccessfulAuthenticationWithBadCredentialsExceptionWithSpecificMessage_when_exceptionIsBadCredentialsExceptionWithSpecificLoginAttempts(
      ...
      Mockito.verify(mockedAuthenticationFailureHandler)
          .onAuthenticationFailure(
              same(httpServletRequest), any(), exceptionArgumentCaptor.capture());
      Assertions.assertThat(exceptionArgumentCaptor.getValue().getMessage())
    ...
    void
        should_callSuperUnsuccessfulAuthenticationWithBadCredentialsExceptionWithSpecificMessage_when_exceptionIsDisabledExceptionWithSpecificMessage(
      ...
      unitUnderTest.unsuccessfulAuthentication(
          httpServletRequest, new MockHttpServletResponse(), disabledException);
    ...
    @Test
    void should_callUnsuccessfulAuthenticationWithException_when_notHandledBefore()
        throws Exception {
      val username = "username";
      val httpServletRequest = createAuthenticationRequest(username, "", "");
      ...
      unitUnderTest.unsuccessfulAuthentication(
          httpServletRequest, new MockHttpServletResponse(), authenticationException);
  ...
  private MockHttpServletRequest createAuthenticationRequest(
      final String username, final String password, final String redirectURL) {
