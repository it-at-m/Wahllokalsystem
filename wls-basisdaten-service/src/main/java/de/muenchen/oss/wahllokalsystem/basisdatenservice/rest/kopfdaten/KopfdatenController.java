...
public class KopfdatenController {
  ...
  @Operation(
      description = "Laden der Kopfdaten für die Wahl {wahlID} für den Wahlbezirk {wahlbezirkID}.",
      responses = {
        @ApiResponse(responseCode = "200", description = "Kopfdaten erfolgreich zurückgegeben.")
      })
  @GetMapping("/{wahlID}/{wahlbezirkID}")
  public KopfdatenDTO getKopfdaten(
