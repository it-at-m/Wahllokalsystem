...
public class WahltageController {
  ...
  @Operation(
      ...
      responses = {
        @ApiResponse(responseCode = "200", description = "Wahltage erfolgreich zurückgegeben.")
      })
  @GetMapping
  public List<WahltagDTO> getWahltage() {
    return wahltageDTOMapper.fromListOfWahltagModelToListOfWahltagDTO(
        wahltageService.getWahltage());
  }
}
