...
public interface AsyncProgressDTOMapper {
    ...
    @Mapping(target = "wahlvorschlaegeLoadingActive", source = ".", qualifiedByName = NAMED_MAPPING_WAHLVORSCHLAEGE_LOADING)
    @Mapping(target = "referendumLoadingActive", source = ".", qualifiedByName = NAMED_MAPPING_REFERENDUMVORLAGEN_LOADING)
