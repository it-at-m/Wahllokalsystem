...
@Builder public record StimmzettelgebietModel(String identifikator,String nummer,String name,LocalDate wahltag,@NotNull StimmzettelgebietsartModel stimmzettelgebietsart){}
