...
public class ReferendumvorlagenService {
  ...
  public ReferendumvorlagenModel getReferendumvorlagen(
    ...
    val referendumBezirkUndWahlID =
        referendumvorlagenModelMapper.toBezirkUndWahlID(referendumvorlagenReferenceModel);
    val existingReferendumvorlagen =
        referendumvorlagenRepository.findByBezirkUndWahlID(referendumBezirkUndWahlID);
  ...
  private ReferendumvorlagenModel cacheReferendumvorlagen(
    ...
    val entitiesToSave =
        referendumvorlagenModelMapper.toEntity(
            importedReferendumvorlagen, referendumBezirkUndWahlID);
    try {
