...
public class ArchUnitTest {
  ...
  private static final ImportOption ignoreGeneratedCodeWlsCommon =
      location -> !location.contains("/common");
  private static final ArchRule RULE_NO_CROSS_DEPENDENCIES_INSIDE_REST_CONVENTION_MATCHED =
      noClasses()
          .that()
          .resideInAnyPackage("..rest..")
          .should()
          .dependOnClassesThat()
          .resideInAnyPackage("..basisdatenservice.domain..");
  private static final ArchRule
      RULE_NO_DATAMODEL_CROSS_DEPENDENCIES_INSIDE_SERVICE_CONVENTION_MATCHED =
          noClasses()
              ...
              .should()
              .dependOnClassesThat()
              .resideInAnyPackage("..rest..", "..basisdaten.domain..");
  ...
  void should_verifyArchUnitRuleForAllClassesWithoutTests_when_running(
      final ArgumentsAccessor arguments) {
  ...
  private static Stream<Arguments> allClassesWithoutTestsRulesToVerify() {
    return Stream.of(
        // --- rest rules
        Arguments.of(
            "DATAMODEL_IN_REST_ENDS_WITH_DTO_CONVENTION_MATCHED",
