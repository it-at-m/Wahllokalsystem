...
class WahlenClientImplTest {
    ...
    class GetWahlen {
        ...
        void should_throwFachlicheWlsException_when_givenNull() {
            ...
            Assertions.assertThatException().isThrownBy(() -> unitUnderTest.getWahlen(new WahltagWithNummerModel(LocalDate.now(), "1")))
        ...
        void should_throwTechnischeWlsException_when_apiInvocationFailed() {
            ...
            Assertions.assertThatException().isThrownBy(() -> unitUnderTest.getWahlen(new WahltagWithNummerModel(testDate, "1"))).isSameAs(mockedException);
        }
