...
class WahltageClientImplTest {
  ...
  @Mock WahltageClientMapper wahltageClientMapper;
  ...
  class GetWahltage {
    ...
    void should_throwFachlicheWlsException_when_givenNull() {
      ...
      Assertions.assertThatException()
          .isThrownBy(() -> unitUnderTest.getWahltage(LocalDate.now()))
    ...
    void should_throwTechnischeWlsException_when_apiInvocationFailed() {
      ...
      Assertions.assertThatException()
          .isThrownBy(() -> unitUnderTest.getWahltage(testDate))
    ...
    private Set<de.muenchen.oss.wahllokalsystem.basisdatenservice.eai.aou.model.WahltagDTO>
      ...
      val wahltag1 =
          new de.muenchen.oss.wahllokalsystem.basisdatenservice.eai.aou.model.WahltagDTO();
