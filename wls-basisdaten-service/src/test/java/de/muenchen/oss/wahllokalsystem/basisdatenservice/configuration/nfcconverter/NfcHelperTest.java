 ...
 */
package de.muenchen.oss.wahllokalsystem.basisdatenservice.configuration.nfcconverter;
...
class NfcHelperTest {
  ...
  private static final String[] NFC_OUTPUT_EXPECTED =
      new String[] {FIRST_NFC, SECOND_NFC, THIRD_NFC};

  @Test
  void should_useNfcConverter_when_givenString() {
  ...
  @Test
  void should_useNfcConverter_when_givenStringBuffer() {
  ...
  @Test
  void should_useNfcConverter_when_givenStringArray() {
  ...
  @Test
  void should_useNfcConverter_when_givenMapOfStrings() {
  ...
  @Test
  void should_useNfcConverter_when_givenCookie() {
  ...
  @Test
  void should_useNfcConverter_when_givenCookieWithoutDomain() {
  ...
  @Test
  void should_useNfcConverter_when_givenCookieArray() {
  ...
  @Test
  void should_returnNull_when_nfcConverterIsGivenCookieArrayWithNull() {
