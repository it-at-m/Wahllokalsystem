...
class KopfdatenRepositoryTest {
  ...
  @Autowired private KopfdatenRepository kopfdatenRepository;
  ...
  @Test
  void should_saveData_when_callingPost() {
    val original =
  ...
  @Test
  void should_deleteAllByBezirkUndWahlIDANDByWahlID_when_callingDeleteAll() {
    val kopfdaten_1 =
        MockDataFactory.createKopfdatenEntityFor(
            "wahlID1",
            "wahlbezirkID1",
