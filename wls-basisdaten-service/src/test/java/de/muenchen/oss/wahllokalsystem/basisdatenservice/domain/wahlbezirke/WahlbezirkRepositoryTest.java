package de.muenchen.oss.wahllokalsystem.basisdatenservice.domain.wahlbezirke;
...
class WahlbezirkRepositoryTest {
  ...
  @Autowired private WahlbezirkRepository repository;
  ...
  void should_deleteWahltag_when_callingDelete() {
    val wahltag1 = LocalDate.now();
    val wahltag2 = LocalDate.now().plusDays(1);
    List<Wahlbezirk> wahlbezirkeToSave1 =
        MockDataFactory.createListOfWahlbezirkEntity("praefix1", wahltag1);
    repository.saveAll(wahlbezirkeToSave1);
    List<Wahlbezirk> wahlbezirkeToSave2 =
        MockDataFactory.createListOfWahlbezirkEntity("praefix2", wahltag2);
