...
class WahltagRepositoryTest {
  ...
  @Autowired private WahltagRepository repository;
  ...
  void should_returnWahltageList_when_findAllByOrderByWahltagAscIsCalled() {
    ...
    wahltageToSave.sort(
        Comparator.comparing(Wahltag::getWahltag).thenComparing(Wahltag::getWahltag));
  ...
  private List<Wahltag> createWahltagList() {
    val wahltag4 =
        new Wahltag(
            "_identifikatorWahltag4",
            LocalDate.now().plusMonths(5),
            "beschreibungWahltag4",
            "nummerWahltag4");
    val wahltag1 =
        new Wahltag(
            "_identifikatorWahltag1",
            LocalDate.now().minusMonths(2),
            "beschreibungWahltag1",
            "nummerWahltag1");
    val wahltag3 =
        new Wahltag(
            "_identifikatorWahltag3",
            LocalDate.now().plusMonths(1),
            "beschreibungWahltag3",
            "nummerWahltag3");
    val wahltag2 =
        new Wahltag(
            "_identifikatorWahltag2",
