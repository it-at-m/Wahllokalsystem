...
class ReferendumvorlagenDTOMapperTest {
  ...
  private final ReferendumvorlagenDTOMapper unitUnderTest =
      Mappers.getMapper(ReferendumvorlagenDTOMapper.class);
          ...
          new ReferendumvorlagenDTO(
              ...
              Set.of(
                  new ReferendumvorlageDTO(
                      ...
                      "frage1",
                      Set.of(
                          new ReferendumoptionDTO("option11", "optionsName11", 1L),
                  ...
                  new ReferendumvorlageDTO(
                      ...
                      "frage2",
                      Set.of(
                          new ReferendumoptionDTO("option21", "optionsName21", 3L),
