...
class HandbuchValidatorTest {
  ...
  @InjectMocks HandbuchValidator unitUnderTest;
  ...
  class ValidHandbuchReferenceOrThrow {
    ...
    void should_notThrowException_when_modelIsValid() {
      ...
      Assertions.assertThatNoException()
          .isThrownBy(() -> unitUnderTest.validHandbuchReferenceOrThrow(validModel));
    }
    ...
    void should_throwException_when_modelIsNull() {
      ...
      Assertions.assertThatThrownBy(() -> unitUnderTest.validHandbuchReferenceOrThrow(null))
    ...
    void should_throwException_when_wahltagIDIsNull() {
      ...
      Assertions.assertThatThrownBy(() -> unitUnderTest.validHandbuchReferenceOrThrow(invalidModel))
          .isSameAs(mockedWlsException);
    }
    ...
    private HandbuchReferenceModel.HandbuchReferenceModelBuilder initValidModel() {
      return HandbuchReferenceModel.builder()
          .wahlbezirksart(WahlbezirkArtModel.BWB)
          .wahltagID("wahltagID");
    }
  }
  ...
  class ValidHandbuchWriteModelOrThrow {
    ...
    void should_notThrowException_when_modelIsValid() {
      ...
      Assertions.assertThatNoException()
          .isThrownBy(() -> unitUnderTest.validHandbuchWriteModelOrThrow(validModel));
    }
    ...
    void should_throwException_when_modelIsNull() {
      ...
      Assertions.assertThatThrownBy(() -> unitUnderTest.validHandbuchWriteModelOrThrow(null))
          .isSameAs(mockedWlsException);
    }
    ...
    void should_throwException_when_handbuchReferenceIsNull() {
      ...
      Assertions.assertThatThrownBy(
              () -> unitUnderTest.validHandbuchWriteModelOrThrow(invalidModel))
          .isSameAs(mockedWlsException);
    }
    ...
    void should_throwException_when_handbuchReferenceWahltagIDIsNull() {
      val invalidModel =
          initValidModel()
              .handbuchReferenceModel(initValidHandbuchReferenceModel().wahltagID(null).build())
              .build();
    ...
    void should_throwException_when_handbuchReferenceWahltagIDIsEmptyString() {
      val invalidModel =
          initValidModel()
              .handbuchReferenceModel(initValidHandbuchReferenceModel().wahltagID("").build())
              .build();
      ...
      val invalidModel =
          initValidModel()
              .handbuchReferenceModel(
                  initValidHandbuchReferenceModel().wahlbezirksart(null).build())
              .build();
    ...
    private HandbuchWriteModel.HandbuchWriteModelBuilder initValidModel() {
      return HandbuchWriteModel.builder()
          .handbuchReferenceModel(initValidHandbuchReferenceModel().build())
          .handbuchData("text".getBytes());
    }
