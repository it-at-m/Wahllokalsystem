...
class UngueltigeWahlscheineValidatorTest {
  ...
  @InjectMocks UngueltigeWahlscheineValidator unitUnderTest;
  ...
  class ValidUngueltigeWahlscheineReferenceOrThrow {
    ...
    void should_returnNoException_when_modelIsValid() {
      ...
      Assertions.assertThatNoException()
          .isThrownBy(() -> unitUnderTest.validUngueltigeWahlscheineReferenceOrThrow(validModel));
    }
    ...
    void should_returnException_when_modelIsNull() {
      Mockito.when(
              exceptionFactory.createFachlicheWlsException(
                  ExceptionConstants.GETUNGUELTIGEWAHLSCHEINE_PARAMETER_UNVOLLSTAENDIG))
          .thenReturn(mockedWlsException);

      Assertions.assertThatThrownBy(
              () -> unitUnderTest.validUngueltigeWahlscheineReferenceOrThrow(null))
    ...
    void should_returnException_when_wahltagIDIsNull() {
      ...
      Assertions.assertThatThrownBy(
              () -> unitUnderTest.validUngueltigeWahlscheineReferenceOrThrow(invalidModel))
          .isSameAs(mockedWlsException);
    }
    ...
    private UngueltigeWahlscheineReferenceModel.UngueltigeWahlscheineReferenceModelBuilder
        initValidModel() {
      return UngueltigeWahlscheineReferenceModel.builder()
          .wahltagID("wahltagID")
          .wahlbezirksart(WahlbezirkArtModel.UWB);
    }
  }
  ...
  class ValidUngueltigeWahlscheineWriteModelOrThrow {
    ...
    void should_returnNoException_when_modelIsValid() {
      ...
      Assertions.assertThatNoException()
          .isThrownBy(() -> unitUnderTest.validUngueltigeWahlscheineWriteModelOrThrow(validModel));
    }
    ...
    void should_returnException_when_modelIsNull() {
      Mockito.when(
              exceptionFactory.createFachlicheWlsException(
                  ExceptionConstants.POSTUNGUELTIGEWS_PARAMETER_UNVOLLSTAENDIG))
          .thenReturn(mockedWlsException);

      Assertions.assertThatThrownBy(
              () -> unitUnderTest.validUngueltigeWahlscheineWriteModelOrThrow(null))
          .isSameAs(mockedWlsException);
    }
    ...
    void should_returnException_when_referenceModelIsNull() {
      ...
      Assertions.assertThatThrownBy(
              () -> unitUnderTest.validUngueltigeWahlscheineWriteModelOrThrow(invalidModel))
          .isSameAs(mockedWlsException);
    }
      ...
      val invalidModel =
          initValidModel()
              .ungueltigeWahlscheineReferenceModel(
                  initValidReferenceModel().wahltagID(null).build())
              .build();
    ...
    void should_returnException_when_wahltagIDIsEmpty() {
      val invalidModel =
          initValidModel()
              .ungueltigeWahlscheineReferenceModel(initValidReferenceModel().wahltagID("").build())
              .build();
    ...
    void should_returnException_when_wahltagIDIsBlankString() {
      val invalidModel =
          initValidModel()
              .ungueltigeWahlscheineReferenceModel(
                  initValidReferenceModel().wahltagID("   ").build())
              .build();
    ...
    void should_returnException_when_wahlbezirksartIsNull() {
      val invalidModel =
          initValidModel()
              .ungueltigeWahlscheineReferenceModel(
                  initValidReferenceModel().wahlbezirksart(null).build())
              .build();
    ...
    private UngueltigeWahlscheineReferenceModel.UngueltigeWahlscheineReferenceModelBuilder
        initValidReferenceModel() {
      return UngueltigeWahlscheineReferenceModel.builder()
          .wahltagID("wahltagID")
          .wahlbezirksart(WahlbezirkArtModel.UWB);
    }

    private UngueltigeWahlscheineWriteModel.UngueltigeWahlscheineWriteModelBuilder
        initValidModel() {
      return UngueltigeWahlscheineWriteModel.builder()
          .ungueltigeWahlscheineReferenceModel(initValidReferenceModel().build())
