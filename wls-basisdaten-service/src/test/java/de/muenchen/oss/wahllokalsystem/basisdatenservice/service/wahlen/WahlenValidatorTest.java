...
class WahlenValidatorTest {
  ...
  @InjectMocks WahlenValidator unitUnderTest;
  ...
  class ValidWahlenCriteriaOrThrow {
    ...
    void should_returnNoException_when_criteriaIsValid() {
      Assertions.assertThatNoException()
          .isThrownBy(() -> unitUnderTest.validWahlenCriteriaOrThrow("validWahltagID"));
    }
    ...
    void should_returnException_when_criteriaIsNull() {
      ...
      Mockito.when(
              exceptionFactory.createFachlicheWlsException(
                  ExceptionConstants.GETWAHLEN_PARAMETER_UNVOLLSTAENDIG))
          .thenReturn(mockedException);

      Assertions.assertThatThrownBy(() -> unitUnderTest.validWahlenCriteriaOrThrow(null))
    ...
    void should_returnException_when_criteriaIsEmpty() {
      ...
      Assertions.assertThatThrownBy(() -> unitUnderTest.validWahlenCriteriaOrThrow(""))
          .isSameAs(mockedException);
    }
  ...
  class ValidWahlenWriteModelOrThrow {
    ...
    void should_returnNoException_when_modelIsValid() {
      ...
      Assertions.assertThatNoException()
          .isThrownBy(() -> unitUnderTest.validWahlenWriteModelOrThrow(validModel));
    }
    ...
    void should_returnException_when_wahltagIDIsNull() {
      ...
      Mockito.when(
              exceptionFactory.createFachlicheWlsException(
                  ExceptionConstants.POSTWAHLEN_PARAMETER_UNVOLLSTAENDIG))
          .thenReturn(mockedException);

      val invalidModel = new WahlenWriteModel(null, List.of(createEmptyWahlModel()));

      Assertions.assertThatThrownBy(() -> unitUnderTest.validWahlenWriteModelOrThrow(invalidModel))
          .isSameAs(mockedException);
    }
