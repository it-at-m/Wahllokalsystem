...
class AsyncWahltermindatenServiceTest {
  ...
  @Mock WahlvorschlaegeClient wahlvorschlaegeClient;
  @Mock ReferendumvorlagenClient referendumvorlagenClient;

  @Mock WahlvorschlaegeRepository wahlvorschlaegeRepository;
  @Mock ReferendumvorlagenRepository referendumvorlagenRepository;

  @Mock WahlvorschlaegeModelMapper wahlvorschlaegeModelMapper;
  @Mock ReferendumvorlagenModelMapper referendumvorlagenModelMapper;

  @InjectMocks AsyncWahltermindatenService unitUnderTest;

  private final MockedStatic<LocalDateTime> mockedStaticLocalDateTime =
  ...
  class InitVorlagenAndVorschlaege {
    ...
    void should_resetProgress_when_methodIsCalled() {
      ...
      unitUnderTest.initVorlagenAndVorschlaege(
          new WahltagWithNummerModel(wahltagDate, wahltagNummer), basisdatenModel);
    ...
    void should_persistWahlvorschlaege_when_basisdatenAreDelivered() {
      ...
      val wahltagNummer = "wahltagNummer";
      val basisdatenModel =
          createBasisdatenModelWith2WahlenAnd2WahlbezirkeForEachWahl(wahltagDate, WahlartModel.BTW);
      ...
      Mockito.when(wahlvorschlaegeClient.getWahlvorschlaege(any()))
          .thenReturn(mockedWahlvorschlaegeClientResponse);
      Mockito.when(wahlvorschlaegeModelMapper.toEntity(mockedWahlvorschlaegeClientResponse))
          .thenReturn(mockedWahlvorschlaegeModelMappedAsEntity);

      unitUnderTest.initVorlagenAndVorschlaege(
          new WahltagWithNummerModel(wahltagDate, wahltagNummer), basisdatenModel);

      Mockito.verify(wahlvorschlaegeRepository, times(4))
          .save(mockedWahlvorschlaegeModelMappedAsEntity);
    ...
    void should_increaseWahlvorstandProgressEven_when_savingFailed() {
      ...
      Mockito.when(wahlvorschlaegeModelMapper.toEntity(mockedWahlvorschlaegeClientResponse))
          .thenReturn(mockedWahlvorschlaegeModelMappedAsEntity);
      Mockito.doThrow(new RuntimeException("saving failed"))
    ...
    void should_increaseWahlvorstandProgressEven_when_loadingWahlvorschlaegeFromClientFailed() {
      ...
      Mockito.doThrow(new RuntimeException("getting data from client failed"))
          .when(wahlvorschlaegeClient)
          .getWahlvorschlaege(any());
    ...
    void should_persistReferendumvorlagen_when_basisdatenAreDelivered() {
      ...
      val wahltagNummer = "wahltagNummer";
      val basisdatenModel =
          createBasisdatenModelWith2WahlenAnd2WahlbezirkeForEachWahl(wahltagDate, WahlartModel.BEB);
      ...
      Mockito.when(referendumvorlagenClient.getReferendumvorlagen(any()))
          .thenReturn(mockedReferendumvorlagenClientResponse);
      Mockito.when(
              referendumvorlagenModelMapper.toEntity(
                  eq(mockedReferendumvorlagenClientResponse), any()))
          .thenReturn(mockedReferendumvorlagenModelMappedAsEntity);

      unitUnderTest.initVorlagenAndVorschlaege(
          new WahltagWithNummerModel(wahltagDate, wahltagNummer), basisdatenModel);

      Mockito.verify(referendumvorlagenRepository, times(4))
          .save(mockedReferendumvorlagenModelMappedAsEntity);
    ...
    @Test
    void
        should_increaseReferendumvorlagenProgressEven_when_loadingReferendumvorlagenFromClientFailed() {
      val wahltagDate = LocalDate.now();
      val wahltagNummer = "wahltagNummer";
      val basisdatenModel =
          createBasisdatenModelWith2WahlenAnd2WahlbezirkeForEachWahl(wahltagDate, WahlartModel.BEB);
      ...
      Mockito.doThrow(new RuntimeException("getting data from client failed"))
          .when(referendumvorlagenClient)
          .getReferendumvorlagen(any());
    ...
    private BasisdatenModel createBasisdatenModelWith2WahlenAnd2WahlbezirkeForEachWahl(
      ...
      val wahlbezirkeModels =
          Set.of(
              new WahlbezirkModel(
                  "wahlbezirkID1", WahlbezirkArtModel.UWB, "1", wahltagDate, "1", "wahlID1"),
              new WahlbezirkModel(
                  "wahlbezirkID2", WahlbezirkArtModel.UWB, "2", wahltagDate, "1", "wahlID1"),
              new WahlbezirkModel(
                  "wahlbezirkID3", WahlbezirkArtModel.UWB, "3", wahltagDate, "2", "wahlID2"),
              new WahlbezirkModel(
                  "wahlbezirkID4", WahlbezirkArtModel.UWB, "4", wahltagDate, "2", "wahlID2"));

      return new BasisdatenModel(
          Collections.emptySet(), wahlenModels, wahlbezirkeModels, Collections.emptySet());
    }
  }
}
