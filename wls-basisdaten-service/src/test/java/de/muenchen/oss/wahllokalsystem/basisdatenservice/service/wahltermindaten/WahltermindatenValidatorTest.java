...
class WahltermindatenValidatorTest {
  ...
  @InjectMocks WahltermindatenValidator unitUnderTest;
  ...
  class ValidateParameterToInitWahltermindaten {
    ...
    void should_throwException_when_wahltagIDIsNull() {
      ...
      Assertions.assertThatThrownBy(
              () -> unitUnderTest.validateParameterToInitWahltermindaten(null))
    ...
    void should_throwException_when_wahltagIDIsEmpty() {
      ...
      Assertions.assertThatThrownBy(() -> unitUnderTest.validateParameterToInitWahltermindaten(""))
          .isSameAs(mockedWlsException);
    }
    ...
    void should_throwException_when_wahltagIDIsBlank() {
      ...
      Assertions.assertThatThrownBy(
              () -> unitUnderTest.validateParameterToInitWahltermindaten("   "))
          .isSameAs(mockedWlsException);
    }
  }
  ...
  class ValidateParameterToDeleteWahltermindaten {
    ...
    void should_throwException_when_wahltagIDIsNull() {
      ...
      Assertions.assertThatThrownBy(
              () -> unitUnderTest.validateParameterToDeleteWahltermindaten(null))
          .isSameAs(mockedWlsException);
    }
    ...
    void should_throwException_when_wahltagIDIsEmpty() {
      ...
      Assertions.assertThatThrownBy(
              () -> unitUnderTest.validateParameterToDeleteWahltermindaten(""))
          .isSameAs(mockedWlsException);
    }
