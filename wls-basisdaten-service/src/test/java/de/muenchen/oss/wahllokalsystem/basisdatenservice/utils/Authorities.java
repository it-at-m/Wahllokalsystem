...
public class Authorities {
  ...
  public static final String SERVICE_GET_WAHLVORSCHLAEGE =
      "Basisdaten_BUSINESSACTION_GetWahlvorschlaege";
  ...
  public static final String SERVICE_GET_UNGUELTIGEWAHLSCHEINE =
      "Basisdaten_BUSINESSACTION_GetUngueltigews";
  public static final String SERVICE_POST_UNGUELTIGEWAHLSCHEINE =
  ...
  public static final String SERVICE_GET_REFERENDUMVORLAGEN =
      "Basisdaten_BUSINESSACTION_GetReferendumvorlagen";

  public static final String SERVICE_GET_WAHLBEZIRKE = "Basisdaten_BUSINESSACTION_GetWahlbezirke";

  public static final String SERVICE_PUT_WAHLTERMINDATEN =
      "Basisdaten_BUSINESSACTION_PutWahltermindaten";
  ...
  public static final String REPOSITORY_WRITE_WAHLVORSCHLAEGE =
      "Basisdaten_WRITE_WLSWahlvorschlaege";
  ...
  public static final String REPOSITORY_WRITE_UNGUELTIGEWAHLSCHEINE =
      "Basisdaten_WRITE_Ungueltigews";
  public static final String REPOSITORY_DELETE_UNGUELTIGEWAHLSCHEINE =
      "Basisdaten_DELETE_Ungueltigews";

  public static final String REPOSITORY_READ_REFERENDUMVORLAGEN =
      "Basisdaten_READ_Referendumvorlagen";
  public static final String REPOSITORY_WRITE_REFERENDUMVORLAGEN =
      "Basisdaten_WRITE_Referendumvorlagen";
  public static final String REPOSITORY_DELETE_REFERENDUMVORLAGEN =
      "Basisdaten_DELETE_Referendumvorlagen";

  public static final String REPOSITORY_READ_REFERENDUMVORLAGE =
      "Basisdaten_READ_Referendumvorlage";
  public static final String REPOSITORY_WRITE_REFERENDUMVORLAGE =
      "Basisdaten_WRITE_Referendumvorlage";
  public static final String REPOSITORY_DELETE_REFERENDUMVORLAGE =
      "Basisdaten_DELETE_Referendumvorlage";
  ...
  public static final String S2S_INFOMANAGEMENT_SERVICE_POST_KONFIGURIERTERWAHLTAG =
      "Infomanagement_BUSINESSACTION_PostKonfigurierterWahltag";
  public static final String S2S_INFOMANAGEMENT_SERVICE_DELETE_KONFIGURIERTERWAHLTAG =
      "Infomanagement_BUSINESSACTION_DeleteKonfigurierterWahltag";
  public static final String S2S_INFOMANAGEMENT_REPOSITORY_READ_KONFIGURIERTERWAHLTAG =
      "Infomanagement_READ_KonfigurierterWahltag";
  public static final String S2S_INFOMANAGEMENT_REPOSITORY_WRITE_KONFIGURIERTERWAHLTAG =
      "Infomanagement_WRITE_KonfigurierterWahltag";
  public static final String S2S_INFOMANAGEMENT_REPOSITORY_DELETE_KONFIGURIERTERWAHLTAG =
      "Infomanagement_DELETE_KonfigurierterWahltag";
  ...
  public static final String[] ALL_AUTHORITIES_SET_WAHLVORSCHLAEGE = {
    SERVICE_GET_WAHLVORSCHLAEGE, REPOSITORY_READ_WAHLVORSCHLAEGE, REPOSITORY_WRITE_WAHLVORSCHLAEGE
  };
  ...
  public static final String[] ALL_AUTHORITIES_GET_HANDBUCH = {
    SERVICE_GET_HANDBUCH, REPOSITORY_READ_HANDBUCH,
  };
  public static final String[] ALL_AUTHORITIES_POST_HANDBUCH = {
    SERVICE_POST_HANDBUCH, REPOSITORY_WRITE_HANDBUCH
  };

  public static final String[] ALL_AUTHORITIES_GET_WAHLTAGE = {
    SERVICE_GET_WAHLTAGE, REPOSITORY_READ_WAHLTAG, REPOSITORY_WRITE_WAHLTAG
  };
  public static final String[] ALL_AUTHORITIES_GET_WAHLTAGBYID = {
    SERVICE_GET_WAHLTAG, REPOSITORY_READ_WAHLTAG
  };
  public static final String[] ALL_AUTHORITIES_SET_WAHLTAGE = {
    SERVICE_GET_WAHLTAGE, REPOSITORY_READ_WAHLTAG, REPOSITORY_WRITE_WAHLTAG
  };

  public static final String[] ALL_AUTHORITIES_DELETE_WAHLTAGE = {REPOSITORY_DELETE_WAHLTAG};

  public static final String[] ALL_AUTHORITIES_RESET_WAHLEN = {
    SERVICE_RESET_WAHLEN, REPOSITORY_READ_WAHL, REPOSITORY_WRITE_WAHL
  };

  public static final String[] ALL_AUTHORITIES_GET_UNGUELTIGEWAHLSCHEINE = {
    SERVICE_GET_UNGUELTIGEWAHLSCHEINE, REPOSITORY_READ_UNGUELTIGEWAHLSCHEINE
  };

  public static final String[] ALL_AUTHORITIES_POST_UNGUELTIGEWAHLSCHEINE = {
    SERVICE_POST_UNGUELTIGEWAHLSCHEINE, REPOSITORY_WRITE_UNGUELTIGEWAHLSCHEINE
  };
  ...
  public static final String[] ALL_AUTHORITIES_GET_WAHLEN = {
    SERVICE_GET_WAHLEN, SERVICE_GET_WAHLTAG, REPOSITORY_READ_WAHL, REPOSITORY_READ_WAHLTAG
  };
  ...
  public static final String[] ALL_AUTHORITIES_READ_KOPFDATEN_IF_DATA_EXISTS_IN_REPO = {
    SERVICE_GET_KOPFDATEN, REPOSITORY_READ_KOPFDATEN
  };

  public static final String[] ALL_AUTHORITIES_READ_KOPFDATEN = {
    SERVICE_GET_KOPFDATEN, REPOSITORY_READ_KOPFDATEN, REPOSITORY_WRITE_KOPFDATEN,
  };
