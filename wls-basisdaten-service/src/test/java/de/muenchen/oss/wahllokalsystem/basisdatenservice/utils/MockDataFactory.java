...
public class MockDataFactory {
  ...
  public static KopfdatenDTO createControllerKopfdatenDTO(
      String wahlID,
      String wahlbezirkID,
      StimmzettelgebietsartDTO szgaDTO,
  ...
  public static KopfdatenModel createKopfdatenModelFor(
      String wahlID,
      String wahlbezirkID,
      StimmzettelgebietsartModel szga,
      String szGebietsNummer,
      String szGebietsName,
      String wahlname,
      String wahlbezirkNummer,
  ...
  public static BasisdatenModel createBasisdatenModel(LocalDate forDate) {
    return new BasisdatenModel(
        Set.of(
            new BasisstrukturdatenModel("wahlID1", "szgID", "wahlbezirkID1_1", forDate),
  ...
  public static BasisdatenDTO createClientBasisdatenDTO(LocalDate aDate) {
    ...
    basisdatenDTO.setBasisstrukturdaten(
        Set.of(
            basisstrukturdaten1,
            basisstrukturdaten2,
            basisstrukturdaten3,
    ...
    basisdatenDTO.setWahlbezirke(
        Set.of(wahlbezirk1, wahlbezirk2, wahlbezirk3, wahlbezirk4, wahlbezirk5));
    basisdatenDTO.setStimmzettelgebiete(Set.of(stimmzettelgebiet1, stimmzettelgebiet2));

    return basisdatenDTO;
  }

  public static KonfigurierterWahltagDTO createClientKonfigurierterWahltagDTO(
  ...
  public static KonfigurierterWahltagModel createClientKonfigurierterWahltagModel(
      LocalDate forDate, Boolean isWahltagActive) {
  ...
  public static List<Wahltag> createWahltagList(String wahltagIDPrefix) {
    val wahltag1 =
        new Wahltag(
            wahltagIDPrefix + "_identifikatorWahltag1",
            LocalDate.now().minusMonths(2),
            "beschreibungWahltag1",
            "nummerWahltag1");
    val wahltag2 =
        new Wahltag(
            wahltagIDPrefix + "_identifikatorWahltag2",
            LocalDate.now().minusMonths(1),
            "beschreibungWahltag2",
            "nummerWahltag2");
    val wahltag3 =
        new Wahltag(
            wahltagIDPrefix + "_identifikatorWahltag3",
  ...
  public static Wahlbezirk createWahlbezirkEntity(final LocalDate wahltagDate) {
    return new Wahlbezirk(
        UUID.randomUUID().toString(), wahltagDate, "nummer", WahlbezirkArt.UWB, "nummer", "wahlID");
  }
  ...
  public static List<WahlbezirkModel> createListOfWahlbezirkModel(
      String praefix, LocalDate forDate) {
    return List.of(
        new WahlbezirkModel(
            praefix + "wahlbezirkID1_1", WahlbezirkArtModel.UWB, "1201", forDate, "0", "wahlID1"),
        new WahlbezirkModel(
            praefix + "wahlbezirkID1_2", WahlbezirkArtModel.BWB, "1251", forDate, "0", "wahlID1"),
        new WahlbezirkModel(
            praefix + "wahlbezirkID2_1", WahlbezirkArtModel.UWB, "1202", forDate, "0", "wahlID1"),
        new WahlbezirkModel(
            praefix + "wahlbezirkID2_2", WahlbezirkArtModel.BWB, "1252", forDate, "0", "wahlID1"));
  }
  ...
  public static List<
      ...
      createWlsWahlbezirkDTOs(final String praefix, final LocalDate forDate) {
    val wahlbezirk1 =
        new de.muenchen.oss.wahllokalsystem.basisdatenservice.rest.wahlbezirke.WahlbezirkDTO(
            praefix + "wahlbezirkID1_1", forDate, "1201", WahlbezirkArtDTO.UWB, "0", "wahlID1");
    val wahlbezirk2 =
        new de.muenchen.oss.wahllokalsystem.basisdatenservice.rest.wahlbezirke.WahlbezirkDTO(
            praefix + "wahlbezirkID1_2", forDate, "1251", WahlbezirkArtDTO.BWB, "0", "wahlID1");
    val wahlbezirk3 =
        new de.muenchen.oss.wahllokalsystem.basisdatenservice.rest.wahlbezirke.WahlbezirkDTO(
            praefix + "wahlbezirkID2_1", forDate, "1202", WahlbezirkArtDTO.UWB, "0", "wahlID1");
    val wahlbezirk4 =
        new de.muenchen.oss.wahllokalsystem.basisdatenservice.rest.wahlbezirke.WahlbezirkDTO(
            praefix + "wahlbezirkID2_2", forDate, "1252", WahlbezirkArtDTO.BWB, "0", "wahlID1");
