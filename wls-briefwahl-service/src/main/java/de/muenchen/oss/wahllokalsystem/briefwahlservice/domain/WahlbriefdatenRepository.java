...
public interface WahlbriefdatenRepository extends CrudRepository<Wahlbriefdaten, String> {
   ...
   *
   * <p>If the oid already exists, the Wahlbriefdaten will be overridden, hence update. If the oid
   * does no already exist, a new Wahlbriefdaten will be created, hence create.
   *
