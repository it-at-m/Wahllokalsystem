...
@Builder public record BeanstandeteWahlbriefeDTO(@NotNull String wahlbezirkID,@NotNull Long waehlerverzeichnisNummer,@Schema(enumAsRef=true,example=SwaggerConfiguration.BEANSTANDETE_WAHLBRIEFE_EXAMPLE)@NotNull Map<String,Zurueckweisungsgrund[]>beanstandeteWahlbriefe){}
