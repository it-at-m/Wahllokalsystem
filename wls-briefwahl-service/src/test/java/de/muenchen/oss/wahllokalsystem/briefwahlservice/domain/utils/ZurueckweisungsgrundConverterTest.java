...
class ZurueckweisungsgrundConverterTest {
  ...
  class ConvertToDatabaseColumn {
    ...
    void should_returnEmptyArray_when_givenEmptyArray() {
      Assertions.assertThat(unitUnderTest.convertToDatabaseColumn(new Zurueckweisungsgrund[0]))
    ...
    void should_convertToString_when_givenArray() {
      val arrayData =
          new Zurueckweisungsgrund[] {
            ...
            Zurueckweisungsgrund.GEGENSTAND_IM_UMSCHLAG,
  ...
  class ConvertToEntityAttribute {
    ...
    void should_convertToEmptyString_when_givenEmptyArray() {
      Assertions.assertThat(unitUnderTest.convertToEntityAttribute(""))
          .isEqualTo(new Zurueckweisungsgrund[0]);
    }

    @Test
    void should_convertToEmptyArray_when_givenNull() {
      Assertions.assertThat(unitUnderTest.convertToEntityAttribute(null))
          .isEqualTo(new Zurueckweisungsgrund[0]);
    }
