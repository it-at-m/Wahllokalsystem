...
class WahlbriefdatenValidatorTest {
  ...
  @InjectMocks WahlbriefdatenValidator unitUnderTest;
  ...
  class ValidWahlbezirkIDOrThrow {
    ...
    void should_notThrowException_when_givenValidWahlbezirkID() {
      ...
      Assertions.assertThatNoException()
          .isThrownBy(() -> unitUnderTest.validWahlbezirkIDOrThrow(validWahlbezirkID));
    }
  ...
  class ValidWahlbriefdatenToSetOrThrow {
    ...
    void should_notThrowException_when_givenValidModel() {
      ...
      Assertions.assertThatNoException()
          .isThrownBy(() -> unitUnderTest.validWahlbriefdatenToSetOrThrow(validModel));
    }
    ...
    void should_throwWlsException_when_modelIsNull() {
      ...
      Assertions.assertThatException()
          .isThrownBy(() -> unitUnderTest.validWahlbriefdatenToSetOrThrow(null))
          .isSameAs(mockedException);
    }
    ...
    void should_throwWlsException_when_wahlbezirkIDIsNull() {
      ...
      Assertions.assertThatException()
          .isThrownBy(() -> unitUnderTest.validWahlbriefdatenToSetOrThrow(invalidModel))
          .isSameAs(mockedException);
    }
