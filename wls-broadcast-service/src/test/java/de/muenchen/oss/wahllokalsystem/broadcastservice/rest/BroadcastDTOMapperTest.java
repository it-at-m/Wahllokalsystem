...
public class BroadcastDTOMapperTest {
  ...
  class ToListOfMessageEntity {
    ...
    void should_returnListOfMessageEntity_when_givenBroadcastMessageDTO() {
      ...
      val expectedListOfMessageEntity =
          TestdataFactory.CreateMessageEntity.listFromBroadcastMessageDto(
              mockedBroadcastMessageDTO, empfangsZeit);
