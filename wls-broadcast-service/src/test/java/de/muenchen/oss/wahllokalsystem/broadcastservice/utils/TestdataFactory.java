...
public class TestdataFactory {
  ...
  public static class CreateMessageEntity {
    ...
    public static Message withCustomParams(
        String wahlbezirkID, String nachricht, LocalDateTime time) {
    ...
    public static List<Message> listFromBroadcastMessageDto(
        BroadcastMessageDTO broadcastMessageDTO, LocalDateTime empfangsZeit) {
      return broadcastMessageDTO
          .wahlbezirkIDs() // TODO: darf die oid null sein?
          .stream()
          .map(
              wahlbezirkId ->
                  new Message(null, wahlbezirkId, broadcastMessageDTO.nachricht(), empfangsZeit))
          .toList();
    }
  }
  ...
  public static class CreateMessageDto {
    ...
    public static MessageDTO fromEntity(Message message) {
      return new MessageDTO(
          message.getOid(),
          message.getWahlbezirkID(),
          message.getNachricht(),
          message.getEmpfangsZeit());
    }

    public static MessageDTO withCustomParams(
        UUID id, String wahlbezirkID, String nachricht, LocalDateTime time) {
  ...
  public static class CreateBroadcastMessageDto {
    ...
    public static BroadcastMessageDTO withCustomParams(
        List<String> wahlbezirkIds, String nachricht) {
