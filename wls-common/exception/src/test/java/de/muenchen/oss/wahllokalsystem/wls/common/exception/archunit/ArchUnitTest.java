...
public class ArchUnitTest {
  ...
  static void init() {
    ...
    allClasses =
        new ClassFileImporter().importPackages(FachlicheWlsException.class.getPackage().getName());
  }
  ...
  // cause: "AbstractExceptionHandlerTest" has protected methods, "SpringContextTest" has no
  // matching "SpringContext" class and "WlsExceptionDTOTest" has no matching methods
