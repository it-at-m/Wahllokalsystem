...
class WlsExceptionFactoryTest {
  ...
  @Mock private WlsExceptionCreator<WlsException> mockedCreator;
  ...
  class BuildWithMessage {
    ...
    void should_returnWlsExceptionWithException_when_buildWithMessageIsCalled() {
      ...
      val dataForBuild =
          new WlsExceptionData("message", "serviceName", "code", new NullPointerException("npe"));
      val mockedWlsException =
          FachlicheWlsException.withCode(dataForBuild.getCode())
              .buildWithMessage(dataForBuild.getMessage());
  ...
  class WithCause {
    ...
    void should_returnFactoryItself_when_called() {
      ...
      Assertions.assertThat(unitUnderTest.withCause(new NullPointerException("npe")))
          .isSameAs(unitUnderTest);
    }
  }
}
