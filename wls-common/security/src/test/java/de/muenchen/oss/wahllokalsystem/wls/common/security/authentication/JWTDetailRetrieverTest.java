    ...
    void should_returnFalse_when_authenticationIsNotJwtAuthenticationToken() {
      Assertions.assertThat(
              unitUnderTest.canHandle(
                  new AbstractAuthenticationToken(Collections.emptyList()) {
                    @Override
  ...
  class GetDetail {
    ...
    void should_returnEmptyOptional_when_authenticationIsNotInstanceOfJwtAuthenticationToken() {
      val result =
          unitUnderTest.getDetail(
              "key", new UsernamePasswordAuthenticationToken("principal", "credentials"));
    ...
    void should_throwsIllegalArgumentException_when_keyIsNull() {
      ...
      Assertions.assertThatThrownBy(
              () -> unitUnderTest.getDetail(null, new JwtAuthenticationToken(jwt)))
          .isInstanceOf(IllegalArgumentException.class);
    }
