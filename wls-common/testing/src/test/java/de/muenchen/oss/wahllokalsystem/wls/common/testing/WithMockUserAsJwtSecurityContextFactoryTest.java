...
class WithMockUserAsJwtSecurityContextFactoryTest {
  ...
  private final WithMockUserAsJwtSecurityContextFactory unitUnderTest =
      new WithMockUserAsJwtSecurityContextFactory();
  ...
  class CreateSecurityContext {
    ...
    void should_createSecurityContextWithAuthorities_when_authoritiesAreGivenInTheAnnotation() {
      val securityContext =
          unitUnderTest.createSecurityContext(
              getAnnotation(TestClassWithAuthoritiesInAnnotations.class));
    ...
    @Test
    void
        should_createSecurityContextWithEmptyAuthoritiesList_when_noAuthoritiesAreGivenInTheAnnotation() {
      val securityContext =
          unitUnderTest.createSecurityContext(
              getAnnotation(TestClassWithNoPropertiesSetInTheAnnotation.class));
    ...
    void should_setUsernameInJwtToken_when_usernameIsGivenInTheAnnotation() {
      val securityContext =
          unitUnderTest.createSecurityContext(
              getAnnotation(TestClassWithUsernameInAnnotation.class));
    ...
    void should_addClaimWithDefaultKeyValueSeparator_when_claimsAreGivenInTheAnnotation() {
      val securityContext =
          unitUnderTest.createSecurityContext(getAnnotation(TestClassWithClaimsInAnnotation.class));
    ...
    void should_addClaimByDefineKeyValueSeparator_when_claimsAndSeparatorAreGivenInTheAnnotation() {
      val securityContext =
          unitUnderTest.createSecurityContext(
              getAnnotation(TestClassWithClaimsAndClaimSeparatorInAnnotation.class));
      ...
      Assertions.assertThatException()
          .isThrownBy(
              () ->
                  unitUnderTest.createSecurityContext(
                      getAnnotation(
                          TestClassWithClaimMismatchingTheRequiredFormatInAnnotation.class)))
...
@WithMockUserAsJwt(
    claimProperties = {"key1;value1", "key2;value2"},
    claimPropertiesSeparator = ";")
class TestClassWithClaimsAndClaimSeparatorInAnnotation {}

@WithMockUserAsJwt(
    claimProperties = {"key=value"},
    claimPropertiesSeparator = ";")
