...
class RequestMappingMethodParameterAnnotationConditionTest {
  ...
  final ArchRule ruleWithConditionUnderTest =
      methods()
          .that()
  ...
  class Check {
    ...
    void should_throwNoException_when_pathVariableAnnotationIsGiven() {
      ruleWithConditionUnderTest.check(
          new ClassFileImporter(List.of(new ImportOption.OnlyIncludeTests()))
              .importClasses(PathVariableAnnotationIsGivenOnParameter.class));
    }
    ...
    void should_throwNoException_when_requestParamAnnotationIsGiven() {
      ruleWithConditionUnderTest.check(
          new ClassFileImporter(List.of(new ImportOption.OnlyIncludeTests()))
              .importClasses(RequestParamAnnotationIsGivenOnParameter.class));
    }
    ...
    void should_throwNoException_when_requestBodyAnnotationIsGiven() {
      ruleWithConditionUnderTest.check(
          new ClassFileImporter(List.of(new ImportOption.OnlyIncludeTests()))
              .importClasses(RequestBodyAnnotationIsGivenOnParameter.class));
    }
    ...
    void should_throwNoException_when_requestHeaderAnnotationIsGiven() {
      ruleWithConditionUnderTest.check(
          new ClassFileImporter(List.of(new ImportOption.OnlyIncludeTests()))
              .importClasses(RequestHeaderAnnotationIsGivenOnParameter.class));
    }
    ...
    void should_throwNoException_when_methodHasZeroParameters() {
      ruleWithConditionUnderTest.check(
          new ClassFileImporter(List.of(new ImportOption.OnlyIncludeTests()))
              .importClasses(NoParametersAreGiven.class));
    }
    ...
    void should_throwNoException_when_eachParameterHasOneOfTheRequiredAnnotation() {
      ruleWithConditionUnderTest.check(
          new ClassFileImporter(List.of(new ImportOption.OnlyIncludeTests()))
              .importClasses(EachParameterHasOneOfTheRequiredAnnotation.class));
    }
    ...
    void should_throwException_when_noRequiredAnnotationIsGiven() {
      Assertions.assertThatThrownBy(
              () ->
                  ruleWithConditionUnderTest.check(
                      new ClassFileImporter(List.of(new ImportOption.OnlyIncludeTests()))
                          .importClasses(NoAnnotationIsGivenOnAnyParameter.class)))
...
class EachParameterHasOneOfTheRequiredAnnotation {
  ...
  @VisibleForTesting
  public void methodUnderTest(
      @PathVariable final String pathVariableParameter,
      @RequestParam final String requestParamParameter,
      @RequestBody final String requestBodyParameter,
      @RequestHeader final String requestHeaderParameter) {}
}
