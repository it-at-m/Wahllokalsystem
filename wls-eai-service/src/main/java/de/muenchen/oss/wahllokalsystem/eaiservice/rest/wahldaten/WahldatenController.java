...
public class WahldatenController {
  ...
  @Operation(
      description =
          "Sucht nach allen Wahlberechtigten in einem Wahlbezirk { wahlbezirkId } und gibt diese zurück.",
      responses = {
        @ApiResponse(
            responseCode = "200",
            description = "Liste aller Wahlberechtigten erfolgreich zurückgegeben.")
      })
  @GetMapping("wahlbezirke/{wahlbezirkID}/wahlberechtigte")
  @ResponseStatus(HttpStatus.OK)
  public List<WahlberechtigteDTO> loadWahlberechtigte(
  ...
  @Operation(
      description =
          "Sucht alle Wahltage seit einem bestimmten wahltag, der wahltag wird bei der suche inkludiert.",
      responses = {
        @ApiResponse(
            responseCode = "200",
            description = "Liste aller Wahltage erfolgreich zurückgegeben.")
      })
  @GetMapping("wahltage")
  @ResponseStatus(HttpStatus.OK)
  ...
  @Operation(
      ...
      responses = {
        @ApiResponse(
            responseCode = "200",
            description = "Liste aller Wahlbezirke erfolgreich zurückgegeben.")
      })
  @GetMapping("wahlbezirk")
  @ResponseStatus(HttpStatus.OK)
  public Set<WahlbezirkDTO> loadWahlbezirke(
      @RequestParam("forDate") LocalDate wahltag, @RequestParam("withNummer") String nummer) {
  ...
  @Operation(
      ...
      responses = {
        @ApiResponse(
            responseCode = "200",
            description = "Liste aller Wahlen erfolgreich zurückgegeben.")
      })
  @GetMapping("wahlen")
  @ResponseStatus(HttpStatus.OK)
  public Set<WahlDTO> loadWahlen(
      @RequestParam("forDate") LocalDate wahltag, @RequestParam("withNummer") String nummer) {
  ...
  @Operation(
      ...
      responses = {
        @ApiResponse(
            responseCode = "200",
            description = "Liste aller Basisdaten erfolgreich zurückgegeben.")
      })
  @GetMapping("basisdaten")
  @ResponseStatus(HttpStatus.OK)
  public BasisdatenDTO loadBasisdaten(
      @RequestParam("forDate") LocalDate wahltag, @RequestParam("withNummer") String nummer) {
