...
INSERT INTO wahlvorschlag (id, ordnungszahl, kurzname, erhaeltStimmen, wahlvorschlaegeID)
VALUES ('00000000-0000-0000-0002-000000000013', 1, 'Vorschlag für Refendum', true,
        '00000000-0000-0000-0000-000000000005');

INSERT INTO kandidat (id, name, listenposition, direktkandidat, tabellenSpalteInNiederschrift, einzelbewerber,
                      wahlvorschlagID)
VALUES ('00000000-0000-0000-0002-000000000016', 'Stark', 1, false, 11, false,
        '00000000-0000-0000-0002-000000000013');
INSERT INTO kandidat (id, name, listenposition, direktkandidat, tabellenSpalteInNiederschrift, einzelbewerber,
                      wahlvorschlagID)
VALUES ('00000000-0000-0000-0002-000000000017', 'Lannister', 2, false, 16, false,
        '00000000-0000-0000-0002-000000000013');
INSERT INTO kandidat (id, name, listenposition, direktkandidat, tabellenSpalteInNiederschrift, einzelbewerber,
                      wahlvorschlagID)
VALUES ('00000000-0000-0000-0002-000000000018', 'Baratheon', 3, true, 25, true,
        '00000000-0000-0000-0002-000000000013');

INSERT INTO referendumvorlagen (id, wahlbezirkID, wahlID, stimmzettelgebietID)
VALUES ('00000000-0000-0000-0002-000000000001', '9081145c-dc16-4a9b-8255-5c49ddb98c14',
        '28039463-3d3d-4ce5-acc1-0bef931a4409', '00000000-0000-0000-0000-000000000005');
