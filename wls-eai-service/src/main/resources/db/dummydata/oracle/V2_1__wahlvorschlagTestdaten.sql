...
INSERT INTO kandidat (id, name, listenposition, direktkandidat, tabellenSpalteInNiederschrift, einzelbewerber,
                      wahlvorschlagID)
VALUES ('00000000-0000-0001-0001-000000000001', 'Clapton', 1, 0, 10, 0,
        '00000000-0000-0000-0001-000000000001');
INSERT INTO kandidat (id, name, listenposition, direktkandidat, tabellenSpalteInNiederschrift, einzelbewerber,
                      wahlvorschlagID)
VALUES ('00000000-0000-0001-0001-000000000002', 'Jagger', 2, 0, 11, 0,
        '00000000-0000-0000-0001-000000000001');
INSERT INTO kandidat (id, name, listenposition, direktkandidat, tabellenSpalteInNiederschrift, einzelbewerber,
                      wahlvorschlagID)
VALUES ('00000000-0000-0001-0001-000000000003', 'Prince', 3, 0, 15, 0,
        '00000000-0000-0000-0001-000000000001');
INSERT INTO kandidat (id, name, listenposition, direktkandidat, tabellenSpalteInNiederschrift, einzelbewerber,
                      wahlvorschlagID)
VALUES ('00000000-0000-0001-0001-000000000004', 'Mac', 4, 0, 16, 1,
        '00000000-0000-0000-0001-000000000001');
INSERT INTO kandidat (id, name, listenposition, direktkandidat, tabellenSpalteInNiederschrift, einzelbewerber,
                      wahlvorschlagID)
VALUES ('00000000-0000-0001-0001-000000000005', 'Cool', 5, 1, 25, 1,
        '00000000-0000-0000-0001-000000000001');
...
INSERT INTO kandidat (id, name, listenposition, direktkandidat, tabellenSpalteInNiederschrift, einzelbewerber,
                      wahlvorschlagID)
VALUES ('00000000-0000-0001-0001-000000000006', 'Bush', 1, 0, 10, 0,
        '00000000-0000-0000-0001-000000000002');
INSERT INTO kandidat (id, name, listenposition, direktkandidat, tabellenSpalteInNiederschrift, einzelbewerber,
                      wahlvorschlagID)
VALUES ('00000000-0000-0001-0001-000000000007', 'Clinton', 2, 0, 11, 0,
        '00000000-0000-0000-0001-000000000002');
INSERT INTO kandidat (id, name, listenposition, direktkandidat, tabellenSpalteInNiederschrift, einzelbewerber,
                      wahlvorschlagID)
VALUES ('00000000-0000-0001-0001-000000000008', 'Biden', 3, 0, 15, 0,
        '00000000-0000-0000-0001-000000000002');
INSERT INTO kandidat (id, name, listenposition, direktkandidat, tabellenSpalteInNiederschrift, einzelbewerber,
                      wahlvorschlagID)
VALUES ('00000000-0000-0001-0001-000000000009', 'Lincoln', 4, 0, 16, 1,
        '00000000-0000-0000-0001-000000000002');
INSERT INTO kandidat (id, name, listenposition, direktkandidat, tabellenSpalteInNiederschrift, einzelbewerber,
                      wahlvorschlagID)
VALUES ('00000000-0000-0001-0001-000000000010', 'Reagan', 5, 1, 25, 1,
        '00000000-0000-0000-0001-000000000002');
...
INSERT INTO kandidat (id, name, listenposition, direktkandidat, tabellenSpalteInNiederschrift, einzelbewerber,
                      wahlvorschlagID)
VALUES ('00000000-0000-0001-0001-000000000011', 'Bush', 1, 0, 10, 0,
        '00000000-0000-0000-0001-000000000003');
INSERT INTO kandidat (id, name, listenposition, direktkandidat, tabellenSpalteInNiederschrift, einzelbewerber,
                      wahlvorschlagID)
VALUES ('00000000-0000-0001-0001-000000000012', 'Clinton', 2, 0, 11, 0,
        '00000000-0000-0000-0001-000000000003');
INSERT INTO kandidat (id, name, listenposition, direktkandidat, tabellenSpalteInNiederschrift, einzelbewerber,
                      wahlvorschlagID)
VALUES ('00000000-0000-0001-0001-000000000013', 'Biden', 3, 0, 15, 0,
        '00000000-0000-0000-0001-000000000003');
INSERT INTO kandidat (id, name, listenposition, direktkandidat, tabellenSpalteInNiederschrift, einzelbewerber,
                      wahlvorschlagID)
VALUES ('00000000-0000-0001-0001-000000000014', 'Lincoln', 4, 0, 16, 1,
        '00000000-0000-0000-0001-000000000003');
INSERT INTO kandidat (id, name, listenposition, direktkandidat, tabellenSpalteInNiederschrift, einzelbewerber,
                      wahlvorschlagID)
VALUES ('00000000-0000-0001-0001-000000000015', 'Reagan', 5, 1, 25, 1,
        '00000000-0000-0000-0001-000000000003');
...
INSERT INTO wahlvorschlag (id, ordnungszahl, kurzname, erhaeltStimmen, wahlvorschlaegeID)
VALUES ('00000000-0000-0000-0002-00000000001', 1, 'Vorschlag für Refendum', 1,
        '00000000-0000-0000-0000-000000000002');
INSERT INTO kandidat (id, name, listenposition, direktkandidat, tabellenSpalteInNiederschrift, einzelbewerber,
                      wahlvorschlagID)
VALUES ('00000000-0000-0002-0002-000000000001', 'Stark', 1, 0, 11, 0,
        '00000000-0000-0000-0002-00000000001');
INSERT INTO kandidat (id, name, listenposition, direktkandidat, tabellenSpalteInNiederschrift, einzelbewerber,
                      wahlvorschlagID)
VALUES ('00000000-0000-0002-0002-000000000002', 'Lannister', 2, 0, 16, 0,
        '00000000-0000-0000-0002-00000000001');
INSERT INTO kandidat (id, name, listenposition, direktkandidat, tabellenSpalteInNiederschrift, einzelbewerber,
                      wahlvorschlagID)
VALUES ('00000000-0000-0002-0002-000000000003', 'Baratheon', 3, 1, 25, 1,
        '00000000-0000-0000-0002-00000000001');
...
INSERT INTO wahlvorschlag (id, ordnungszahl, kurzname, erhaeltStimmen, wahlvorschlaegeID)
VALUES ('00000000-0000-0000-0003-000000000001', 1, 'Die Besten', 1,
        '00000000-0000-0000-0000-000000000003');
INSERT INTO kandidat (id, name, listenposition, direktkandidat, tabellenSpalteInNiederschrift, einzelbewerber,
                      wahlvorschlagID)
VALUES ('00000000-0000-0003-0003-000000000001', 'Clapton', 1, 0, 10, 0,
        '00000000-0000-0000-0003-000000000001');
INSERT INTO kandidat (id, name, listenposition, direktkandidat, tabellenSpalteInNiederschrift, einzelbewerber,
                      wahlvorschlagID)
VALUES ('00000000-0000-0003-0003-000000000002', 'Jagger', 2, 0, 11, 0,
        '00000000-0000-0000-0003-000000000001');
INSERT INTO kandidat (id, name, listenposition, direktkandidat, tabellenSpalteInNiederschrift, einzelbewerber,
                      wahlvorschlagID)
VALUES ('00000000-0000-0003-0003-000000000003', 'Prince', 3, 0, 15, 0,
        '00000000-0000-0000-0003-000000000001');
INSERT INTO kandidat (id, name, listenposition, direktkandidat, tabellenSpalteInNiederschrift, einzelbewerber,
                      wahlvorschlagID)
VALUES ('00000000-0000-0003-0003-000000000004', 'Mac', 4, 0, 16, 1,
        '00000000-0000-0000-0003-000000000001');
INSERT INTO kandidat (id, name, listenposition, direktkandidat, tabellenSpalteInNiederschrift, einzelbewerber,
                      wahlvorschlagID)
VALUES ('00000000-0000-0003-0003-000000000005', 'Cool', 5, 1, 25, 1,
        '00000000-0000-0000-0003-000000000001');

INSERT INTO wahlvorschlag (id, ordnungszahl, kurzname, erhaeltStimmen, wahlvorschlaegeID)
VALUES ('00000000-0000-0000-0003-000000000002', 2, 'Die Zweitbesten', 1,
        '00000000-0000-0000-0000-000000000003');
INSERT INTO kandidat (id, name, listenposition, direktkandidat, tabellenSpalteInNiederschrift, einzelbewerber,
                      wahlvorschlagID)
VALUES ('00000000-0000-0003-0003-000000000006', 'Bush', 1, 0, 10, 0,
        '00000000-0000-0000-0003-000000000002');
INSERT INTO kandidat (id, name, listenposition, direktkandidat, tabellenSpalteInNiederschrift, einzelbewerber,
                      wahlvorschlagID)
VALUES ('00000000-0000-0003-0003-000000000007', 'Clinton', 2, 0, 11, 0,
        '00000000-0000-0000-0003-000000000002');
INSERT INTO kandidat (id, name, listenposition, direktkandidat, tabellenSpalteInNiederschrift, einzelbewerber,
                      wahlvorschlagID)
VALUES ('00000000-0000-0003-0003-000000000008', 'Biden', 3, 0, 15, 0,
        '00000000-0000-0000-0003-000000000002');
INSERT INTO kandidat (id, name, listenposition, direktkandidat, tabellenSpalteInNiederschrift, einzelbewerber,
                      wahlvorschlagID)
VALUES ('00000000-0000-0003-0003-000000000009', 'Lincoln', 4, 0, 16, 1,
        '00000000-0000-0000-0003-000000000002');
INSERT INTO kandidat (id, name, listenposition, direktkandidat, tabellenSpalteInNiederschrift, einzelbewerber,
                      wahlvorschlagID)
VALUES ('00000000-0000-0003-0003-000000000010', 'Reagan', 5, 1, 25, 1,
        '00000000-0000-0000-0003-000000000002');

INSERT INTO wahlvorschlag (id, ordnungszahl, kurzname, erhaeltStimmen, wahlvorschlaegeID)
VALUES ('00000000-0000-0000-0003-000000000003', 3, 'Die Drittbesten', 1,
        '00000000-0000-0000-0000-000000000003');
INSERT INTO kandidat (id, name, listenposition, direktkandidat, tabellenSpalteInNiederschrift, einzelbewerber,
                      wahlvorschlagID)
VALUES ('00000000-0000-0003-0003-000000000011', 'Bush', 1, 0, 10, 0,
        '00000000-0000-0000-0003-000000000003');
INSERT INTO kandidat (id, name, listenposition, direktkandidat, tabellenSpalteInNiederschrift, einzelbewerber,
                      wahlvorschlagID)
VALUES ('00000000-0000-0003-0003-000000000012', 'Clinton', 2, 0, 11, 0,
        '00000000-0000-0000-0003-000000000003');
INSERT INTO kandidat (id, name, listenposition, direktkandidat, tabellenSpalteInNiederschrift, einzelbewerber,
                      wahlvorschlagID)
VALUES ('00000000-0000-0003-0003-000000000013', 'Biden', 3, 0, 15, 0,
        '00000000-0000-0000-0003-000000000003');
INSERT INTO kandidat (id, name, listenposition, direktkandidat, tabellenSpalteInNiederschrift, einzelbewerber,
                      wahlvorschlagID)
VALUES ('00000000-0000-0003-0003-000000000014', 'Lincoln', 4, 0, 16, 1,
        '00000000-0000-0000-0003-000000000003');
INSERT INTO kandidat (id, name, listenposition, direktkandidat, tabellenSpalteInNiederschrift, einzelbewerber,
                      wahlvorschlagID)
VALUES ('00000000-0000-0003-0003-000000000015', 'Reagan', 5, 1, 25, 1,
        '00000000-0000-0000-0003-000000000003');
...
INSERT INTO wahlvorschlag (id, ordnungszahl, kurzname, erhaeltStimmen, wahlvorschlaegeID)
VALUES ('00000000-0000-0000-0004-000000000001', 1, 'Vorschlag für Refendum', 1,
        '00000000-0000-0000-0000-000000000004');
INSERT INTO kandidat (id, name, listenposition, direktkandidat, tabellenSpalteInNiederschrift, einzelbewerber,
                      wahlvorschlagID)
VALUES ('00000000-0000-0002-0004-000000000001', 'Stark', 1, 0, 11, 0,
        '00000000-0000-0000-0004-000000000001');
INSERT INTO kandidat (id, name, listenposition, direktkandidat, tabellenSpalteInNiederschrift, einzelbewerber,
                      wahlvorschlagID)
VALUES ('00000000-0000-0002-0004-000000000002', 'Lannister', 2, 0, 16, 0,
        '00000000-0000-0000-0004-000000000001');
INSERT INTO kandidat (id, name, listenposition, direktkandidat, tabellenSpalteInNiederschrift, einzelbewerber,
                      wahlvorschlagID)
VALUES ('00000000-0000-0002-0004-000000000003', 'Baratheon', 3, 1, 25, 1,
        '00000000-0000-0000-0004-000000000001');
