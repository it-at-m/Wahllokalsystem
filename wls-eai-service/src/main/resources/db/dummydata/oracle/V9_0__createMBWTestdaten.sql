...
INSERT INTO KANDIDAT (ID, NAME, LISTENPOSITION, DIREKTKANDIDAT, TABELLENSPALTEINNIEDERSCHRIFT,
                      EINZELBEWERBER, WAHLVORSCHLAGID)
...
-- Wahlvorschlag 1 (BWB) - 6 Kandidaten
INSERT INTO WAHLVORSCHLAG (ID, ORDNUNGSZAHL, KURZNAME, ERHAELTSTIMMEN, WAHLVORSCHLAEGEID)
...
INSERT INTO KANDIDAT (ID, NAME, LISTENPOSITION, DIREKTKANDIDAT, TABELLENSPALTEINNIEDERSCHRIFT,
                      EINZELBEWERBER, WAHLVORSCHLAGID)
VALUES ('e9f0a1b2-c3d4-4e5f-6a7b-8c9d0e1f2a3c', 'Linh Nguyen', 4, 0, 4, 0, 'a5b6c7d8-e9f0-4a1b-2c3d-4e5f6a7b8c9e');

INSERT INTO KANDIDAT (ID, NAME, LISTENPOSITION, DIREKTKANDIDAT, TABELLENSPALTEINNIEDERSCHRIFT,
                      EINZELBEWERBER, WAHLVORSCHLAGID)
VALUES ('f0a1b2c3-d4e5-4f6a-7b8c-9d0e1f2a3b4d', 'Viktor Kozlov', 5, 0, 5, 0, 'a5b6c7d8-e9f0-4a1b-2c3d-4e5f6a7b8c9e');

INSERT INTO KANDIDAT (ID, NAME, LISTENPOSITION, DIREKTKANDIDAT, TABELLENSPALTEINNIEDERSCHRIFT,
                      EINZELBEWERBER, WAHLVORSCHLAGID)
VALUES ('a1b2c3d4-e5f6-4a7b-8c9d-0e1f2a3b4c5f', 'Sarah Al-Mansour', 6, 0, 6, 0, 'a5b6c7d8-e9f0-4a1b-2c3d-4e5f6a7b8c9e');

-- Wahlvorschlag 2 (BWB) - 3 Kandidaten
INSERT INTO WAHLVORSCHLAG (ID, ORDNUNGSZAHL, KURZNAME, ERHAELTSTIMMEN, WAHLVORSCHLAEGEID)
...
-- Wahlvorschlag 3 (BWB) - 5 Kandidaten
INSERT INTO WAHLVORSCHLAG (ID, ORDNUNGSZAHL, KURZNAME, ERHAELTSTIMMEN, WAHLVORSCHLAEGEID)
...
INSERT INTO KANDIDAT (ID, NAME, LISTENPOSITION, DIREKTKANDIDAT, TABELLENSPALTEINNIEDERSCHRIFT,
                      EINZELBEWERBER, WAHLVORSCHLAGID)
VALUES ('e1f2a3b4-c5d6-4e7f-8a9b-0c1d2e3f4a5d', 'Chen Wei', 5, 0, 5, 0, 'f6a7b8c9-d0e1-4f2a-3b4c-5d6e7f8a9b0e');

-- Wahlvorschlag 4 (BWB) - 4 Kandidaten
INSERT INTO WAHLVORSCHLAG (ID, ORDNUNGSZAHL, KURZNAME, ERHAELTSTIMMEN, WAHLVORSCHLAEGEID)
...
-- Wahlvorschlag 5 (BWB) - 6 Kandidaten
INSERT INTO WAHLVORSCHLAG (ID, ORDNUNGSZAHL, KURZNAME, ERHAELTSTIMMEN, WAHLVORSCHLAEGEID)
...
INSERT INTO KANDIDAT (ID, NAME, LISTENPOSITION, DIREKTKANDIDAT, TABELLENSPALTEINNIEDERSCHRIFT,
                      EINZELBEWERBER, WAHLVORSCHLAGID)
VALUES ('c1d2e3f4-a5b6-4c7d-8e9f-0a1b2c3d4e5b', 'Lucia Fernandez', 4, 0, 4, 0, 'e7f8a9b0-c1d2-4e3f-4a5b-6c7d8e9f0a1d');

INSERT INTO KANDIDAT (ID, NAME, LISTENPOSITION, DIREKTKANDIDAT, TABELLENSPALTEINNIEDERSCHRIFT,
                      EINZELBEWERBER, WAHLVORSCHLAGID)
VALUES ('d2e3f4a5-b6c7-4d8e-9f0a-1b2c3d4e5f6c', 'Sergei Volkov', 5, 0, 5, 0, 'e7f8a9b0-c1d2-4e3f-4a5b-6c7d8e9f0a1d');

INSERT INTO KANDIDAT (ID, NAME, LISTENPOSITION, DIREKTKANDIDAT, TABELLENSPALTEINNIEDERSCHRIFT,
                      EINZELBEWERBER, WAHLVORSCHLAGID)
VALUES ('e3f4a5b6-c7d8-4e9f-0a1b-2c3d4e5f6a7d', 'Nadia Ahmed', 6, 0, 6, 0, 'e7f8a9b0-c1d2-4e3f-4a5b-6c7d8e9f0a1d');

-- Wahlvorschlag 6 (BWB) - 3 Kandidaten
INSERT INTO WAHLVORSCHLAG (ID, ORDNUNGSZAHL, KURZNAME, ERHAELTSTIMMEN, WAHLVORSCHLAEGEID)
...
-- Wahlvorschlag 7 (BWB) - 5 Kandidaten
INSERT INTO WAHLVORSCHLAG (ID, ORDNUNGSZAHL, KURZNAME, ERHAELTSTIMMEN, WAHLVORSCHLAEGEID)
...
INSERT INTO KANDIDAT (ID, NAME, LISTENPOSITION, DIREKTKANDIDAT, TABELLENSPALTEINNIEDERSCHRIFT,
                      EINZELBEWERBER, WAHLVORSCHLAGID)
VALUES ('c3d4e5f6-a7b8-4c9d-0e1f-2a3b4c5d6e7c', 'Tomas Horvath', 5, 0, 5, 0, 'd8e9f0a1-b2c3-4d4e-5f6a-7b8c9d0e1f2c');
