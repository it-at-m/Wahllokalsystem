...
public class Authorities {
  ...
  public static final String SERVICE_LOAD_WAHLVORSCHLAEGE =
      "aoueai_BUSINESSACTION_LoadWahlvorschlaege";
  public static final String SERVICE_LOAD_WAHLVORSCHLAEGELISTE =
      "aoueai_BUSINESSACTION_LoadWahlvorschlaegeListe";
  public static final String SERVICE_LOAD_REFERENDUMVORLAGEN =
      "aoueai_BUSINESSACTION_LoadReferendumvorlagen";

  public static final String SERVICE_LOAD_WAHLBERECHTIGTE =
      "aoueai_BUSINESSACTION_LoadWahlberechtigte";
  ...
  public static final String SERVICE_SAVE_WAHLBETEILIGUNG =
      "aoueai_BUSINESSACTION_SaveWahlbeteiligung";

  public static final String SERVICE_SAVE_ERGEBNISMELDUNG =
      "aoueai_BUSINESSACTION_SaveErgebnismeldung";

  public static final String SERVICE_SAVE_WAHLLOKALZUSTAND =
  ...
  public static final String[] ALL_AUTHORIRITES_SETANWESENHEIT = {SERVICE_SAVE_ANWESENHEIT};
