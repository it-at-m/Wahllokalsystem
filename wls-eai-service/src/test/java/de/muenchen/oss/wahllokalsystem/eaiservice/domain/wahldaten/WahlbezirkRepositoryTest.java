...
class WahlbezirkRepositoryTest {
  ...
  @Autowired WahlbezirkRepository unitUnderTest;
  ...
  class FindWahlbezirkeWithStimmzettelgebietAndWahlAndWahltagByWahltagAndNummer {
    ...
    void should_returnWahlbezirk_when_givenValidWahltagAndNummer() {
      ...
      val wahlbezirk2ToFind =
          unitUnderTest.save(new Wahlbezirk(WahlbezirkArt.UWB, "wbz2", szg1, 0, 0, 0));
      ...
      val result =
          unitUnderTest.findWahlbezirkeWithStimmzettelgebietAndWahlAndWahltagByWahltagAndNummer(
              wahltag, nummer);

      val expectedResult = new Wahlbezirk[] {wahlbezirk1ToFind, wahlbezirk2ToFind};
  ...
  class FindWahlbezirkeWithStimmzettelgebietAndWahlAndWahltagByID {
    ...
    void should_returnWahlbezirk_when_givenValidWahlbezirkID() {
      ...
      val result =
          unitUnderTest.findWahlbezirkeWithStimmzettelgebietAndWahlAndWahltagByID(
