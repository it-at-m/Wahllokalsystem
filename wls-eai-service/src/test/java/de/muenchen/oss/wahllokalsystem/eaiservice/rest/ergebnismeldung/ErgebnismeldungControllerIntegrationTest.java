...
public class ErgebnismeldungControllerIntegrationTest {
  ...
  @Autowired ErgebnismeldungRepository ergebnismeldungRepository;

  @MockitoSpyBean ErgebnismeldungValidator ergebnismeldungValidator;
  ...
  class SaveErgebnismeldung {
    ...
    void should_setNewData_when_callingPost() throws Exception {
      ...
      val request =
          MockMvcRequestBuilders.post("/ergebnismeldung")
              .with(csrf())
      ...
      Assertions.assertThat(savedErgebnismeldung)
          .usingRecursiveComparison()
          .ignoringFields("id", "erstellungszeit")
