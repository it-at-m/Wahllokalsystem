...
public class ErgebnismeldungServiceSecurityTest {
  ...
  @Autowired private ErgebnismeldungService ergebnismeldungService;
  ...
  class SaveErgebnismeldung {
    ...
    void should_notThrowException_when_givenAllAuthorities() {
      ...
      Assertions.assertThatNoException()
          .isThrownBy(() -> ergebnismeldungService.saveErgebnismeldung(ergebnismeldungToSave));
    }
