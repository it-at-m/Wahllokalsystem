...
class WahlbeteiligungValidatorTest {
  ...
  @InjectMocks WahlbeteiligungValidator unitUnderTest;
  ...
  class validDTOToSetOrThrow {
    ...
    void should_notThrowException_when_wahlbeteiligungsMeldungDTOIsValid() {
      ...
      Assertions.assertThatNoException()
          .isThrownBy(() -> unitUnderTest.validDTOToSetOrThrow(dtoToValidate));
    }
    ...
    void should_throwWlsException_when_wahlIDIsNull() {
      ...
      Assertions.assertThatThrownBy(() -> unitUnderTest.validDTOToSetOrThrow(dtoToValidate))
    ...
    void should_throwWlsException_when_wahlbezirkIDIsNull() {
      ...
      val dtoToValidate =
          new WahlbeteiligungsMeldungDTO(wahlID, null, anzahlWaehler, meldeZeitpunkt);
