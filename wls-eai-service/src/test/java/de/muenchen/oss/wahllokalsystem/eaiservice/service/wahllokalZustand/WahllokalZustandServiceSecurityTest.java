...
public class WahllokalZustandServiceSecurityTest {
    ...
    class SetWahllokalZustand {
        ...
        void should_notThrowAnyException_when_allAuthoritiesAreGiven() {
            ...
            Assertions.assertThatNoException().isThrownBy(() -> wahllokalZustandService.setWahllokalZustand(
                    new WahllokalZustandDTO("2853ba2d-baaa-49ee-93f7-a653d17d6a72", null, null, Collections.emptySet())));
        }
        ...
        void should_throwAccessDeniedException_when_anyAuthorityMissing(final ArgumentsAccessor argumentsAccessor) {
            ...
            Assertions.assertThatThrownBy(() -> wahllokalZustandService.setWahllokalZustand(
                    new WahllokalZustandDTO("2853ba2d-baaa-49ee-93f7-a653d17d6a72", null, null, Collections.emptySet())))
                    .isInstanceOf(AccessDeniedException.class);
        }

        private static Stream<Arguments> getMissingAuthoritiesVariations() {
            return SecurityUtils.buildArgumentsForMissingAuthoritiesVariations(Authorities.ALL_AUTHORITIES_SETWAHLLOKALZUSTAND);
        }
    }
}
