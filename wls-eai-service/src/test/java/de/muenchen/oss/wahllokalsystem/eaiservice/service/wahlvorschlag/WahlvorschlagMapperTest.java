        ...
        class WahlvorschlagMapping {
            ...
            void should_returnWahlvorschlaegeDTO_when_givenWahlvorschlaegeEntity() {
                ...
                val expectedKandidaten1 = Set.of(
                        ...
                        new KandidatDTO(kandidat2.getId().toString(), kandidat2.getName(), kandidat2.getListenposition(), kandidat2.isDirektkandidat(),
                                kandidat2.getTabellenSpalteInNiederschrift(), kandidat2.isEinzelbewerber()));
                val expectedWahlvorschlag1 = new WahlvorschlagDTO(wahlvorschlag1.getId().toString(), wahlvorschlag1.getOrdnungszahl(),
                ...
                val expectedWahlvorschlag2 = new WahlvorschlagDTO(wahlvorschlag2.getId().toString(), wahlvorschlag2.getOrdnungszahl(),
