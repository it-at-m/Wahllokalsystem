  ...
  class ToDTO {
    ...
    class WahlvorschlagMapping {
      ...
      void should_returnWahlvorschlagDTO_when_givenWahlvorschlagEntity() {
        val kandidat1 = new Kandidat("name1", 1, false, 1, false, 1);
        kandidat1.setId(UUID.randomUUID());
        val kandidat2 = new Kandidat("name2", 2, true, 2, true, 2);
        ...
        val expectedKandidaten =
            Set.of(
                new KandidatDTO(
                    kandidat1.getId().toString(),
                    kandidat1.getName(),
                    kandidat1.getListenposition(),
                    kandidat1.isDirektkandidat(),
                    kandidat1.getTabellenSpalteInNiederschrift(),
                    kandidat1.isEinzelbewerber(),
                    kandidat1.getAnzahlNennungen()),
                new KandidatDTO(
                    kandidat2.getId().toString(),
                    kandidat2.getName(),
                    kandidat2.getListenposition(),
                    kandidat2.isDirektkandidat(),
                    kandidat2.getTabellenSpalteInNiederschrift(),
                    kandidat2.isEinzelbewerber(),
                    kandidat2.getAnzahlNennungen()));
        val expectedResult =
            new WahlvorschlagDTO(
                entityToMap.getId().toString(),
                entityToMap.getOrdnungszahl(),
                entityToMap.getKurzname(),
                entityToMap.isErhaeltStimmen(),
                expectedKandidaten);
      ...
      void should_returnWahlvorschlaegeDTO_when_givenWahlvorschlaegeEntity() {
        val kandidat1 = new Kandidat("name1", 1, false, 1, false, 1);
        kandidat1.setId(UUID.randomUUID());
        val kandidat2 = new Kandidat("name2", 2, true, 2, true, 1);
        kandidat2.setId(UUID.randomUUID());
        ...
        val kandidat3 = new Kandidat("name3", 1, false, 1, false, 2);
        kandidat3.setId(UUID.randomUUID());
        val kandidat4 = new Kandidat("name4", 2, true, 2, true, 3);
        ...
        val expectedKandidaten1 =
            Set.of(
                ...
                new KandidatDTO(
                    ...
                    kandidat2.isEinzelbewerber(),
                    kandidat2.getAnzahlNennungen()));
        val expectedWahlvorschlag1 =
            new WahlvorschlagDTO(
                wahlvorschlag1.getId().toString(),
                wahlvorschlag1.getOrdnungszahl(),
                wahlvorschlag1.getKurzname(),
                wahlvorschlag1.isErhaeltStimmen(),
                expectedKandidaten1);
        val expectedKandidaten2 =
            Set.of(
                new KandidatDTO(
                    kandidat3.getId().toString(),
                    kandidat3.getName(),
                    kandidat3.getListenposition(),
                    kandidat3.isDirektkandidat(),
                    kandidat3.getTabellenSpalteInNiederschrift(),
                    kandidat3.isEinzelbewerber(),
                    kandidat3.getAnzahlNennungen()),
                new KandidatDTO(
                    kandidat4.getId().toString(),
                    kandidat4.getName(),
                    kandidat4.getListenposition(),
                    kandidat4.isDirektkandidat(),
                    kandidat4.getTabellenSpalteInNiederschrift(),
                    kandidat4.isEinzelbewerber(),
                    kandidat4.getAnzahlNennungen()));
        val expectedWahlvorschlag2 =
            new WahlvorschlagDTO(
                wahlvorschlag2.getId().toString(),
                wahlvorschlag2.getOrdnungszahl(),
                wahlvorschlag2.getKurzname(),
                wahlvorschlag2.isErhaeltStimmen(),
                expectedKandidaten2);

        val expectedResult =
            new WahlvorschlaegeDTO(
                wahlvorschlaege.getWahlbezirkID(),
                wahlvorschlaege.getWahlID(),
      ...
      void should_returnWahlvorschlaegeListeDTO_when_givenWahlvorschlaegeListeEntity() {
        val kandidat1 = new Kandidat("name1", 1, false, 1, false, 3);
        kandidat1.setId(UUID.randomUUID());
        val kandidat2 = new Kandidat("name2", 2, true, 2, true, 1);
        kandidat2.setId(UUID.randomUUID());
        val kandidaten1 = Set.of(kandidat1, kandidat2);
        ...
        val kandidat3 = new Kandidat("name3", 1, false, 1, false, 2);
        kandidat3.setId(UUID.randomUUID());
        val kandidat4 = new Kandidat("name4", 2, true, 2, true, 1);
        kandidat4.setId(UUID.randomUUID());
        val kandidaten2 = Set.of(kandidat3, kandidat4);
        val wahlvorschlag2 = new Wahlvorschlag(1, "wahlvorschlag2", true, kandidaten2);
        wahlvorschlag2.setId(UUID.randomUUID());
        ...
        val wahlvorschlaegeListe =
            new WahlvorschlaegeListe(LocalDate.of(2024, 10, 10), "wahlID", Set.of(wahlvorschlaege));
        ...
        val expectedResult =
            new WahlvorschlaegeListeDTO(
                wahlvorschlaegeListe.getWahlID(), Set.of(expectedWahlvorschlaege));
    ...
    class ReferendumMapping {
      ...
      void should_returnReferendumoptionDTO_when_givenReferendumoptionEntity() {
        ...
        val expectedResult =
            new ReferendumoptionDTO(
                entityToMap.getId().toString(), entityToMap.getName(), entityToMap.getPosition());
      ...
      void should_returnReferendumvorlageDTO_when_givenReferendumvorlageEntity() {
        ...
        val expectedReferendumoptionen =
            Set.of(
                new ReferendumoptionDTO(
                    referendumoption1.getId().toString(),
                    referendumoption1.getName(),
                    referendumoption1.getPosition()),
                new ReferendumoptionDTO(
                    referendumoption2.getId().toString(),
                    referendumoption2.getName(),
                    referendumoption2.getPosition()));
        val expectedResult =
            new ReferendumvorlageDTO(
                entityToMap.getWahlvorschlagID(),
                entityToMap.getOrdnungszahl(),
                entityToMap.getKurzname(),
                entityToMap.getFrage(),
                expectedReferendumoptionen);
      ...
      void should_returnReferendumvorlagenDTO_when_givenReferendumvorlagenEntity() {
        ...
        val entityToMap =
            new Referendumvorlagen(
                ...
                "wahlID",
                "stimmzettelgebietID",
                Set.of(referendumvorlage1, referendumvorlage2));
        entityToMap.setId(UUID.randomUUID());
        val result = unitUnderTest.toDTO(entityToMap);

        val expectedReferendumoptionen1 =
            Set.of(
                new ReferendumoptionDTO(
                    referendumoption1.getId().toString(),
                    referendumoption1.getName(),
                ...
                new ReferendumoptionDTO(
                    ...
                    referendumoption2.getName(),
                    referendumoption2.getPosition()));
        val expectedReferendumoptionen2 =
            Set.of(
                new ReferendumoptionDTO(
                    referendumoption3.getId().toString(),
                    referendumoption3.getName(),
                    referendumoption3.getPosition()),
                new ReferendumoptionDTO(
                    referendumoption4.getId().toString(),
                    referendumoption4.getName(),
                    referendumoption4.getPosition()));
        val expectedReferendumvorlage1 =
            new ReferendumvorlageDTO(
                referendumvorlage1.getWahlvorschlagID(),
                referendumvorlage1.getOrdnungszahl(),
                referendumvorlage1.getKurzname(),
                referendumvorlage1.getFrage(),
                expectedReferendumoptionen1);
        val expectedReferendumvorlage2 =
            new ReferendumvorlageDTO(
                referendumvorlage2.getWahlvorschlagID(),
                referendumvorlage2.getOrdnungszahl(),
                referendumvorlage2.getKurzname(),
                referendumvorlage2.getFrage(),
                expectedReferendumoptionen2);

        val expectedResult =
            new ReferendumvorlagenDTO(
                entityToMap.getStimmzettelgebietID(),
