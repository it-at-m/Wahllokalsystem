...
class WahlvorschlagValidatorTest {
  ...
  @InjectMocks WahlvorschlagValidator unitUnderTest;
  ...
  class ValidateWahlIDOrThrow {
    ...
    void should_notThrowException_when_wahlIDIsValid() {
      Assertions.assertThatNoException()
          .isThrownBy(() -> unitUnderTest.validateWahlIDOrThrow(UUID.randomUUID().toString()));
    }
    ...
    void should_throwWlsException_when_wahlIDIsNull() {
      ...
      Assertions.assertThatException()
          .isThrownBy(() -> unitUnderTest.validateWahlIDOrThrow(null))
          .isSameAs(mockedFachlicheWlsException);
    }
    ...
    void should_throwWlsException_when_wahlIDIsEmpty() {
      ...
      Assertions.assertThatException()
          .isThrownBy(() -> unitUnderTest.validateWahlIDOrThrow(""))
          .isSameAs(mockedFachlicheWlsException);
    }
