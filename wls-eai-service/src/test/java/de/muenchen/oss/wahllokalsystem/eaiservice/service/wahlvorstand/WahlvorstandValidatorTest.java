...
class WahlvorstandValidatorTest {
  ...
  @InjectMocks WahlvorstandValidator unitUnderTest;
  ...
  class ValidateWahlbezirkIDOrThrow {
    ...
    void should_notThrowException_when_wahlbezirkIDIsValid() {
      Assertions.assertThatNoException()
          .isThrownBy(
              () -> unitUnderTest.validateWahlbezirkIDOrThrow(UUID.randomUUID().toString()));
    }
    ...
    void should_throwWlsException_when_wahlbezirkIDIsNull() {
      ...
      Assertions.assertThatException()
          .isThrownBy(() -> unitUnderTest.validateWahlbezirkIDOrThrow(null))
    ...
    void should_throwWlsException_when_wahlbezirkIDIsEmpty() {
      ...
      Assertions.assertThatException()
          .isThrownBy(() -> unitUnderTest.validateWahlbezirkIDOrThrow(""))
          .isSameAs(mockedFachlicheWlsException);
    }
  ...
  class ValidateSaveAnwesenheitDataOrThrow {
    ...
    void should_notThrowException_when_aktualisierungIsValid() {
      ...
      Assertions.assertThatNoException()
          .isThrownBy(() -> unitUnderTest.validateSaveAnwesenheitDataOrThrow(validDTO));
    }
    ...
    void should_throwWlsException_when_aktualisierungIDIsNull() {
      ...
      Assertions.assertThatException()
          .isThrownBy(() -> unitUnderTest.validateSaveAnwesenheitDataOrThrow(null))
    ...
    void should_throwWlsException_when_wahlbezirkIDIsNull() {
      ...
      Assertions.assertThatException()
          .isThrownBy(() -> unitUnderTest.validateSaveAnwesenheitDataOrThrow(invalidDTO))
          .isSameAs(mockedValidationException);
    }
    ...
    class ExceptionWhenMitgliederIdIsInvalid {
      ...
      void should_throwWlsException_when_mitgliederIDIsNull() {
        val invalidDTO =
            initValidAktualisierung()
                .mitglieder(
                    Set.of(
                        initValidMitgliedAktualisierung().build(),
                        initValidMitgliedAktualisierung().identifikator(null).build()))
                .build();
        ...
        val invalidDTO =
            initValidAktualisierung()
                .mitglieder(
                    Set.of(
                        initValidMitgliedAktualisierung().build(),
                        initValidMitgliedAktualisierung().identifikator("").build()))
                .build();
    ...
    private WahlvorstandsaktualisierungDTO.WahlvorstandsaktualisierungDTOBuilder
        initValidAktualisierung() {
      return WahlvorstandsaktualisierungDTO.builder()
          .anwesenheitBeginn(LocalDateTime.now())
          .wahlbezirkID("wahlbezirkID")
          .mitglieder(Collections.emptySet());
    }

    private WahlvorstandsmitgliedAktualisierungDTO.WahlvorstandsmitgliedAktualisierungDTOBuilder
        initValidMitgliedAktualisierung() {
