...
public class BasePathConfiguration {
  ...
  private final de.muenchen.oss.wahllokalsystem.ergebnismeldungservice.eai.aou.ApiClient
      eaiApiClient;
  private final de.muenchen.oss.wahllokalsystem.ergebnismeldungservice.eai.monitoring.ApiClient
      monitoringApiClient;
  private final de.muenchen.oss.wahllokalsystem.ergebnismeldungservice.eai.infomanagement.ApiClient
      infomanagementApiClient;
  private final de.muenchen.oss.wahllokalsystem.ergebnismeldungservice.eai.basisdaten.ApiClient
      basisdatentApiClient;
  private final de.muenchen.oss.wahllokalsystem.ergebnismeldungservice.eai.briefwahl.ApiClient
      briefwahlApiClient;
  private final de.muenchen.oss.wahllokalsystem.ergebnismeldungservice.eai.wahlvorbereitung
          .ApiClient
      wahlvorbereitungApiClient;
