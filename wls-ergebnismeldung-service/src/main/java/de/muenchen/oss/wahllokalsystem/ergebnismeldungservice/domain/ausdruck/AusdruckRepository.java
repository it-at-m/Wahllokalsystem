...
public interface AusdruckRepository
    extends CrudRepository<Ausdruck, WahlUndBezirkIDUndMeldungsart> {

  @Query(
      "SELECT a FROM Ausdruck a WHERE a.wahlUndBezirkIDUndMeldungsart.wahlID = :wahlID AND a.wahlUndBezirkIDUndMeldungsart.wahlbezirkID = :wahlbezirkID")
