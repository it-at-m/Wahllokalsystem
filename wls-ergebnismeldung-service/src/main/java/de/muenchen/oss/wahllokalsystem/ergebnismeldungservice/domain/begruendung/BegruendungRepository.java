...
public interface BegruendungRepository
    extends CrudRepository<Begruendung, BezirkUndWahlIDStapelart> {

  String CACHE = "BegruendungCACHE";

  @Override
  @NonNull Iterable<Begruendung> findAll();

  @Override
  @NonNull @CacheEvict(value = CACHE, key = "#p0")
  ...
  @NonNull <S extends Begruendung> S save(@NonNull S bedruendung);
