...
import de.muenchen.oss.wahllokalsystem.ergebnismeldungservice.domain.TheEntity;
 ...
 */
@PreAuthorize(
    "hasAuthority(T(de.muenchen.oss.wahllokalsystem.ergebnismeldungservice.security.AuthoritiesEnum).WLS_ERGEBNISMELDUNG_SERVICE_READ_THEENTITY.name())"
)
public interface TheEntityRepository extends CrudRepository<TheEntity, UUID> { //NOSONAR
    ...
    @PreAuthorize(
        "hasAuthority(T(de.muenchen.oss.wahllokalsystem.ergebnismeldungservice.security.AuthoritiesEnum).WLS_ERGEBNISMELDUNG_SERVICE_WRITE_THEENTITY.name())"
    )
    ...
    @PreAuthorize(
        "hasAuthority(T(de.muenchen.oss.wahllokalsystem.ergebnismeldungservice.security.AuthoritiesEnum).WLS_ERGEBNISMELDUNG_SERVICE_DELETE_THEENTITY.name())"
    )
