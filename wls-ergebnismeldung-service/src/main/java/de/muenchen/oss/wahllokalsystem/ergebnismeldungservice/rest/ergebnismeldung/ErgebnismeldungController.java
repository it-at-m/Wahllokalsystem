...
public class ErgebnismeldungController {
  ...
  @ApiResponses(
      value = {
        ...
        @ApiResponse(
            responseCode = "409",
            description =
                "Die Übermittlung konnte auf Grund fehlender Daten nicht durchgeführt werden",
            content = {
              @Content(
  ...
  public ResponseEntity<?> sendErgebnisse(
    ...
    log.info(
        "sendErgebnisse called with wahlID: {}, wahlbezirkID: {}, waehlerverzeichnisNummer: {}, meldungsart: {}, hauptwahlbezirkID: {}",
        wahlID,
        wahlbezirkID,
    ...
    if (shouldUpdateSendungszeiten) {
      ...
      ResponseEntity<?> conflictStatus =
          handleSendErgebnismeldung(
              wahlID, wahlbezirkID, waehlerverzeichnisNummer, meldungsart, hauptwahlbezirkID);
  ...
  @Nullable private ResponseEntity<?> handleSendErgebnismeldung(
      final String wahlID,
      final String wahlbezirkID,
      final Long waehlerverzeichnisNummer,
      final MeldungsartDTO meldungsart,
    ...
    try {
      ...
      valid =
          ergebnismeldungService.sendErgebnisse(
              new ErgebnisseToSendCriteriaModel(
                  wahlID, wahlbezirkID, waehlerverzeichnisNummer, modelEnum, hauptwahlbezirkID));
