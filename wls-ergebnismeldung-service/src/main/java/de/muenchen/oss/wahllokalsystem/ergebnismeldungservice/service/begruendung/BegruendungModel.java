...
@Builder
public record BegruendungModel(@NotNull String wahlbezirkID, @NotNull String wahlID, @NotNull Stapelart stapelart, @NotNull String grund1, @NotNull String grund2,
