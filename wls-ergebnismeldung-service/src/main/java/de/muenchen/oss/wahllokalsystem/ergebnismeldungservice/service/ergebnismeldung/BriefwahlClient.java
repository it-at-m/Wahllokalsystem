...
public interface BriefwahlClient {
   ...
   * @return count of beanstandete wahlbriefe with {@link
   *     de.muenchen.oss.wahllokalsystem.ergebnismeldungservice.eai.briefwahl.model.Zurueckweisungsgrund}
   *     not {@link
   *     de.muenchen.oss.wahllokalsystem.ergebnismeldungservice.eai.briefwahl.model.Zurueckweisungsgrund#ZUGELASSEN}.
   *     Is 0 when no wahl with wahlID exists
   ...
   *     beanstandete wahlbriefe for filter wahlbezirkID and waehlerverzeichnisnummer exists
   */
  long getAnzahlZurueckgewiesenerWahlbriefe(
      String wahlbezirkID, String wahlID, long waehlerverzeichnisNummer);
}
