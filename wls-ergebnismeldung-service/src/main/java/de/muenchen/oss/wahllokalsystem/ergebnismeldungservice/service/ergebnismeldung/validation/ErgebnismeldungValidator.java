...
public class ErgebnismeldungValidator {
  ...
  public void validErgebnisseToSendCriteriaOrThrow(
      final ErgebnisseToSendCriteriaModel ergebnisseToSendCriteria) {
    if (ergebnisseToSendCriteria == null
        || StringUtils.isBlank(ergebnisseToSendCriteria.wahlID())
        || StringUtils.isBlank(ergebnisseToSendCriteria.wahlbezirkID())
        || StringUtils.isBlank(ergebnisseToSendCriteria.hauptwahlbezirkID())) {
      throw exceptionFactory.createFachlicheWlsException(
          ExceptionConstants.SENDERGEBNISSE_PARAMETER_UNVOLLSTAENDIG);
    }
  }
  ...
  public boolean checkValidation(
      ...
      final WahlbezirkArtModel wahlbezirksart,
        ...
        .orElseThrow(
            () ->
                new IllegalArgumentException(
                    "#checkValidation kann mit Wahlart" + wahlart.name() + " nicht umgehen :("));
  }
}
