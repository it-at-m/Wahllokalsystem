...
@Builder public record ErgebnisseModel(@NotNull String wahlbezirkID,@NotNull String wahlID,@NotNull StapelartModel stapelart,@NotNull List<ErgebnisModel>ergebnisse){}
