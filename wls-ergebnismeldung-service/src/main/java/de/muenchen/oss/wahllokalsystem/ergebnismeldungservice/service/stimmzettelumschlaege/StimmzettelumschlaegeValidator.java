...
public class StimmzettelumschlaegeValidator {
  ...
  public void validStimmzettelumschlaegeOrThrow(
      final StimmzettelumschlaegeModel stimmzettelumschlaegeModel) {
  ...
  public void validHasBWBRequiredEroeffnungsUhrzeitOrThrow(
      final WahlbezirkArtModel wahlbezirkArt, LocalDateTime urnenEroeffnungsUhrzeit) {
