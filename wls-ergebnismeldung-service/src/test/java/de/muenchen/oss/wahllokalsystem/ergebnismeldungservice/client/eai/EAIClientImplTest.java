...
class EAIClientImplTest {
  ...
  @Mock ErgebnismeldungControllerApi ergebnismeldungControllerApi;

  @Mock AWerteClientMapper aWerteClientMapper;

  @Mock ExceptionFactory exceptionFactory;

  @InjectMocks EAIClientImpl unitUnderTest;
  ...
  class SendErgebnismeldung {
    ...
    void should_throwTechnischeWlsException_when_apiThrewException() {
      val ergebnismeldungDTO =
          new ErgebnismeldungDTO().meldungsart(ErgebnismeldungDTO.MeldungsartEnum.SCHNELLMELDUNG);
      ...
      Mockito.doThrow(new RuntimeException("api call failed"))
          .when(ergebnismeldungControllerApi)
          .saveErgebnismeldung(ergebnismeldungDTO);
      Mockito.when(
      ...
      Assertions.assertThatException()
          .isThrownBy(() -> unitUnderTest.sendErgebnismeldung(ergebnismeldungDTO))
