...
class WahlvorbereitungClientImplTest {
  ...
  @Mock UrnenwahlSchliessungsUhrzeitControllerApi urnenwahlSchliessungsUhrzeitControllerApi;

  @Mock ExceptionFactory exceptionFactory;

  @InjectMocks WahlvorbereitungClientImpl unitUnderTest;
  ...
  class IsWahlbezirkGeschlossen {
    ...
    @Test
    void
        should_dontRequireAdditionalChecksOnSchliessungsUhrzeit_when_propertyUrnenwahlSchliessungsUhrzeitIsAnnotatedWithNonnull()
    ...
    void should_rethrowWlsException_when_apiThrewWlsException() {
      ...
      Mockito.doThrow(mockedApiWlsException)
          .when(urnenwahlSchliessungsUhrzeitControllerApi)
          .getUrnenwahlSchliessungsUhrzeit(wahlbezirkID);

      Assertions.assertThatException()
          .isThrownBy(() -> unitUnderTest.isWahlbezirkGeschlossen(wahlbezirkID))
