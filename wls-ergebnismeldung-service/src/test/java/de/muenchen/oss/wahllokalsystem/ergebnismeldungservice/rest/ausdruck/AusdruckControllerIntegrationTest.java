...
public class AusdruckControllerIntegrationTest {
  ...
  @Autowired AusdruckModelMapper ausdruckModelMapper;

  @Autowired AusdruckDTOMapper ausdruckDTOMapper;
  ...
  class PostAusdruck {
    ...
    @Test
    void should_returnInternalServerError_when_requestPathParameterMeldungsartIsNull()
        throws Exception {
      val wahlID = "wahlID";
      val wahlbezirkID = "wahlbezirkID";
      val content = "Testausdruck";
