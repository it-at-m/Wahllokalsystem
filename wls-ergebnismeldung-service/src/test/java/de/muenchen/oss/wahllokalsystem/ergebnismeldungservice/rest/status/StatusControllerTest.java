...
class StatusControllerTest {
  ...
  @Mock StatusDTOMapper statusDTOMapper;

  @InjectMocks StatusController unitUnderTest;
  ...
  class GetStatus {
    ...
    void should_returnDTOWithHttpStatusOk_when_serviceReturnedData() {
      ...
      Mockito.when(statusDTOMapper.toDTO(mockedServiceResponse))
  ...
  class SetStatus {
    ...
    void should_callServiceWithModel_when_calledWithData() {
      ...
      val mockedStatusModel =
          new StatusModel(new BezirkUndWahlID(wahlID, wahlbezirkID), null, null);
      ...
      Mockito.verify(statusService)
          .setStatus(eq(new BezirkUndWahlID(wahlID, wahlbezirkID)), eq(mockedStatusModel));
    }
  }
}
