...
class StatusDTOMapperTest {
  ...
  class ToDTO {
    ...
    void should_returnDTO_when_givenModel() {
      ...
      val modelToMap =
          new StatusModel(
              ...
              new MeldungModel(ValidierungsstatusModel.VALIDE, true, true, now),
      ...
      val expectedResult =
          new StatusDTO(
              new BezirkUndWahlID(wahlID, wahlbezirkID),
              new MeldungDTO(ValidierungsstatusDTO.VALIDE, true, true, now),
    ...
    void should_mapToEnumWithSameName_when_givenModelValidierungsstatusEnumValue(
      ...
      Assertions.assertThat(result.niederschrift().validierungsstatus().name())
          .isEqualTo(validierungsstatus.name());
      Assertions.assertThat(result.schnellmeldung().validierungsstatus().name())
          .isEqualTo(validierungsstatus.name());
    }
  }
  ...
  class ToModel {
    ...
    void should_mapToEnumWithSameName_when_givenModelValidierungsstatusEnumValue(
        final ValidierungsstatusDTO validierungsstatus) {
      val dtoToMap =
          new StatusDTO(
              null,
