...
public class StimmzettelerfassungTeamStatusControllerIntegrationTest {
      ...
      val expectedEntity =
          Instancio.of(StimmzettelerfassungTeamStatus.class)
              ...
              .set(
                  ...
                  ErfassungTeamStatus.valueOf(requestBody.status().name()))
              .create();
      ...
      val requestBody =
          Instancio.of(StimmzettelerfassungTeamStatusDTO.class)
              .set(
                  ...
                  ErfassungTeamStatusDTO.IN_BEARBEITUNG)
              .create();
  ...
  class GetStimmzettelerfassungTeamStatus {
    ...
    void should_returnData_when_dataIsPresentInRepository() throws Exception {
      ...
      val expectedResult =
          new StimmzettelerfassungTeamStatusDTO(ErfassungTeamStatusDTO.UNTERBROCHEN);
