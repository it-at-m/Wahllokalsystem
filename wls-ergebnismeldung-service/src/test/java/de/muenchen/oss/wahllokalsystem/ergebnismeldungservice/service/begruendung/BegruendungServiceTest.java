...
class BegruendungServiceTest {
  ...
  @Mock BegruendungRepository begruendungRepository;

  @Mock BegruendungModelMapper begruendungModelMapper;

  @Mock BegruendungValidator begruendungValidator;

  @InjectMocks BegruendungService unitUnderTest;
  ...
  class GetBegruendung {
    ...
    void should_returnBegruendungModel_when_begruendungIsFoundFromRepo() {
      ...
      Mockito.when(begruendungModelMapper.toEmbeddedId(reference)).thenReturn(mappedEntityId);
      Mockito.when(begruendungRepository.findById(mappedEntityId))
  ...
  class PostBegruendung {
    ...
    void should_throwTechnischeException_when_called() {
      ...
      Assertions.assertThatThrownBy(() -> unitUnderTest.postBegruendung(reference, model))
