...
class ErgebnismeldungValidatorTest {
  ...
  @Mock ElectionTypeValidation validator;

  @Mock List<ElectionTypeValidation> electionTypeValidations;

  @InjectMocks ErgebnismeldungValidator unitUnderTest;
  ...
  class ValidBezirkUndWahlIDOrThrow {
    ...
    void should_notThrowAnyException_when_bezirkUndWahlIDIsValid() {
      ...
      Assertions.assertThatNoException()
          .isThrownBy(() -> unitUnderTest.validBezirkUndWahlIDOrThrow(bezirkUndWahlID));
    }

    @ParameterizedTest(name = "{1}")
    @MethodSource("streamWithInvalidBezirkUndWahlID")
    void should_throwFachlicheWlsException_when_bezirkUndWahlIDIsInvalid(
      ...
      Mockito.when(
              exceptionFactory.createFachlicheWlsException(
                  ExceptionConstants.SENDERGEBNISSE_PARAMETER_UNVOLLSTAENDIG))
  ...
  class ValidErgebnisseToSendCriteriaOrThrow {
    ...
    void should_notThrowAnyException_when_ergebnisseToSendCriteriaAreValid() {
      val criteria =
          new ErgebnisseToSendCriteriaModel(
              "wahlID", "wahlbezirkID", 0L, MeldungsartModel.V1, "hauptwahlbezirkID");

      Assertions.assertThatNoException()
          .isThrownBy(() -> unitUnderTest.validErgebnisseToSendCriteriaOrThrow(criteria));
    }

    @ParameterizedTest(name = "{1}")
    @MethodSource("streamWithInvalidCriteria")
    void should_throwFachlicheWlsException_when_ergebnisseToSendCriteriaAreInvalid(
        final ArgumentsAccessor arguments) {
      val mockedWlsException =
          FachlicheWlsException.withCode("000").buildWithMessage("validation failed");
      Mockito.when(
      ...
      Assertions.assertThatException()
          .isThrownBy(
              () ->
                  unitUnderTest.validErgebnisseToSendCriteriaOrThrow(
                      arguments.get(0, ErgebnisseToSendCriteriaModel.class)))
          .isSameAs(mockedWlsException);
    }
    ...
    public static Stream<Arguments> streamWithInvalidCriteria() {
      return Stream.of(
          ...
          Arguments.of(
              new ErgebnisseToSendCriteriaModel(
                  null, "wahlbezirkID", 0L, MeldungsartModel.V1, "hauptwahlbezirkID"),
              "wahlID is null"),
          Arguments.of(
              new ErgebnisseToSendCriteriaModel(
                  "", "wahlbezirkID", 0L, MeldungsartModel.V1, "hauptwahlbezirkID"),
              "wahlID is empty"),
          Arguments.of(
              new ErgebnisseToSendCriteriaModel(
                  "    ", "wahlbezirkID", 0L, MeldungsartModel.V1, "hauptwahlbezirkID"),
          ...
          Arguments.of(
              new ErgebnisseToSendCriteriaModel(
                  "wahlID", null, 0L, MeldungsartModel.V1, "hauptwahlbezirkID"),
              "wahlbezirkID is null"),
          Arguments.of(
              new ErgebnisseToSendCriteriaModel(
                  "wahlID", "", 0L, MeldungsartModel.V1, "hauptwahlbezirkID"),
          ...
          Arguments.of(
              new ErgebnisseToSendCriteriaModel(
                  "wahlID", "wahlbezirkID", 0L, MeldungsartModel.V1, null),
              "hauptwahlbezirkID is null"),
          Arguments.of(
              new ErgebnisseToSendCriteriaModel(
                  "wahlID", "wahlbezirkID", 0L, MeldungsartModel.V1, ""),
              "hauptwahlbezirkID is empty"),
          Arguments.of(
              new ErgebnisseToSendCriteriaModel(
                  "wahlID", "wahlbezirkID", 0L, MeldungsartModel.V1, "    "),
              "hauptwahlbezirkID is blank"));
    }
  }
  ...
  class CheckValidation {
    ...
    void should_returnValidatorResponseOfUWBValidator_when_wahlbezirkArtIsUWB(
      ...
      Mockito.when(
              validator.isValidUwb(
                  eq(wahlbezirkID), eq(wahlID), eq(waehlerverzeichnisNumemr), eq(meldungsart)))
          .thenReturn(expectedValidationResult);

      val result =
          unitUnderTest.checkValidation(
              wahlart, wahlbezirkArt, wahlbezirkID, wahlID, waehlerverzeichnisNumemr, meldungsart);
    ...
    @ParameterizedTest
    @ValueSource(booleans = {true, false})
    void should_returnValidatorResponseOfBWBValidator_when_wahlbezirkArtIsBWB(
        final boolean expectedValidationResult) {
