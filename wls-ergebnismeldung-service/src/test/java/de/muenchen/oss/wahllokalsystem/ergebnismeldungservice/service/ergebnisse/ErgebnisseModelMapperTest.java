...
class ErgebnisseModelMapperTest {
  ...
  private final ErgebnisseModelMapper unitUnderTest =
      Mappers.getMapper(ErgebnisseModelMapper.class);
  ...
  class ToModel {
    ...
    void should_returnErgebnisseModel_when_givenErgebnisseEntity() {
      ...
      val expectedResult =
          new ErgebnisseModel("bezirkID", "wahlID", StapelartModel.LTW_BZW_A, newErgebnisModelList);
  ...
  class ToEmbeddedId {
    ...
    void should_returnEmbeddedId_when_givenErgebnisseReference() {
      val ergebnisseReference =
          new ErgebnisseReferenceModel("bezirkID", "wahlID", StapelartModel.LTW_BZW_A);
