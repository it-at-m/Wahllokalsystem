...
class BedenklicheStimmzettelValidatorTest {
    ...
    @InjectMocks
    BedenklicheStimmzettelValidator unitUnderTest;
    ...
    class ValidateGetBedenklicheStimmzettelParameterOrThrow {
        ...
        void should_notThrowAnyException_when_parametersAreValid() {
            Assertions.assertThatNoException().isThrownBy(() -> unitUnderTest.validateGetBedenklicheStimmzettelParameterOrThrow(new BezirkUndWahlID("wahlID", "wahlbezirkID")));
        }
        ...
        void should_throwProvidedException_when_bezirkUndWahlIdIsNotValid(
            ...
            val mockedException = FachlicheWlsException.withCode("000").buildWithMessage("mocked fachliche wls exception");
            Mockito.when(exceptionFactory.createFachlicheWlsException(ExceptionConstants.GET_BEDENKLICHE_STIMMZETTEL_PARAMETER_UNVOLLSTAENDIG)).thenReturn(mockedException);
    ...
    class ValidateSetBedenklicheStimmzettelParameterOrThrow {
        ...
        @Test
        void should_notThrowAnyException_when_parametersAreValid() {
            Assertions.assertThatNoException().isThrownBy(() -> unitUnderTest.validateSetBedenklicheStimmzettelParameterOrThrow(new BezirkUndWahlID("wahlID", "wahlbezirkID"), Collections.emptyList()));
        }
        ...
        void should_throwProvidedException_when_bezirkUndWahlIdIsNotValid(
                final ArgumentsAccessor arguments) {
            val mockedException = FachlicheWlsException.withCode("000").buildWithMessage("mocked fachliche wls exception");
            Mockito.when(exceptionFactory.createFachlicheWlsException(ExceptionConstants.POST_BEDENKLICHE_STIMMZETTEL_UNVOLLSTAENDIG)).thenReturn(mockedException);
        ...
        public static Stream<Arguments> invalidArgumentsWithTestcaseNameAppendix() {
            return Stream.of(
                    ...
                    Arguments.of(new BezirkUndWahlID("wahlID", "wahlbezirkID"), null, "collection argument is null"),
                    Arguments.of(new BezirkUndWahlID(null, "wahlbezirkID"), Collections.emptyList(), "wahlID is null"),
                    Arguments.of(new BezirkUndWahlID("", "wahlbezirkID"), Collections.emptyList(), "wahlID is empty"),
                    Arguments.of(new BezirkUndWahlID("   ", "wahlbezirkID"), Collections.emptyList(), "wahlID is blank"),
                    Arguments.of(new BezirkUndWahlID("wahlID", null), Collections.emptyList(), "wahlbezirkID is null"),
                    Arguments.of(new BezirkUndWahlID("wahlID", ""), Collections.emptyList(), "wahlbezirkID is is empty"),
                    Arguments.of(new BezirkUndWahlID("wahlID", "   "), Collections.emptyList(), "wahlbezirkID is blank"));
        }
    }
