...
class StatusModelMapperTest {
  ...
  class ToModel {
    ...
    void should_returnStatusModel_when_givenStatusEntity() {
      ...
      val expectedResult =
          new StatusModel(
              ...
              new MeldungModel(
                  ValidierungsstatusModel.INVALIDE,
                  schnellmeldung.isGedruckt(),
                  schnellmeldung.getUebermittelt(),
                  schnellmeldung.getSendeuhrzeit()),
              new MeldungModel(
                  ValidierungsstatusModel.VALIDE,
                  niederschrift.isGedruckt(),
                  niederschrift.getUebermittelt(),
    ...
    void should_mapToEnumWithSameName_when_givenEntityValidierungsstatusEnumValue(
        final Validierungsstatus validierungsstatus) {
      val niederschrift = new Meldung();
      ...
      val expectedResult =
          new StatusModel(
              null,
              new MeldungModel(
                  ValidierungsstatusModel.valueOf(validierungsstatus.name()), false, null, null),
              new MeldungModel(
                  ValidierungsstatusModel.valueOf(validierungsstatus.name()), false, null, null));
      Assertions.assertThat(result).isEqualTo(expectedResult);
    }
  ...
  class ToEntity {
    ...
    void should_returnStatusEntity_when_givenStatusModel() {
      val statusModel =
          new StatusModel(
              ...
              new MeldungModel(
                  ValidierungsstatusModel.INVALIDE, true, true, LocalDateTime.now().minusDays(1)));
      ...
      val expectedResult =
          new Status(
              new BezirkUndWahlID("wahlID", "wahlbezirkID"),
              expectedSchnellMeldung,
              expectedNiederschrift);
    ...
    void should_mapToEnumWithSameName_when_givenModelValidierungsstatusEnumValue(
      ...
      val expectedSchnellmeldung = new Meldung();
      expectedSchnellmeldung.setValidierungsstatus(
          Validierungsstatus.valueOf(validierungsstatus.name()));
      val expectedNiederschrift = new Meldung();
      expectedNiederschrift.setValidierungsstatus(
          Validierungsstatus.valueOf(validierungsstatus.name()));
