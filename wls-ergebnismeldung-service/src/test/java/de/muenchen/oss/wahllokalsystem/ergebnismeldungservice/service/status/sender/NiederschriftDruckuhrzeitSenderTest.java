...
class NiederschriftDruckuhrzeitSenderTest {
  ...
  @InjectMocks NiederschriftDruckuhrzeitSender unitUnderTest;
  ...
  class SubmitStatus {
    ...
    void should_callStatusClientPostNiederschriftDruckuhrzeit_when_requirementsAreMet(
    ...
    void should_notCallStatusClientPostNiederschriftDruckuhrzeit_when_requirementsAreNotMet(
        final ArgumentsAccessor arguments) {
      val id = new BezirkUndWahlID();
      val newStatus = arguments.get(0, StatusModel.class);
      val oldStatus = arguments.get(1, StatusModel.class);
