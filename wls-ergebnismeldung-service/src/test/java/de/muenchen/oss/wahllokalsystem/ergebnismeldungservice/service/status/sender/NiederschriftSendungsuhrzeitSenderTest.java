...
class NiederschriftSendungsuhrzeitSenderTest {
  ...
  @InjectMocks NiederschriftSendungsuhrzeitSender unitUnderTest;
  ...
  class SubmitStatus {
    ...
    void
        should_callStatusClientPostNiederschriftSendungsuhrzeit_when_onlyNewStatusIsGivenWithValidierungsstatusNotNICHT_VALIDIERT(
            final ValidierungsstatusModel validierungsstatus) {
      val id = new BezirkUndWahlID();
      val newStatus =
          createStatusModelWithNiederschrift(
    ...
    void should_callStatusClientPostNiederschriftSendungsuhrzeit_when_validierungsstatusChanged(
    ...
    void should_notCallStatusClientPostNiederschriftSendungsuhrzeit_when_requirementsAreNotMet(
        final ArgumentsAccessor arguments) {
      val id = new BezirkUndWahlID();
    ...
    void
        should_notCallStatusClientPostNiederschriftSendungsuhrzeit_when_oldAndNewValidierungsstatusAreEqual(
            final ValidierungsstatusModel validierungsstatus) {
      val id = new BezirkUndWahlID();
      val newStatus =
          createStatusModelWithNiederschrift(
    ...
    public static Stream<Arguments> getArgumentsWhereSubmitIsNotCalledWithTestcaseNameAppendix() {
      return Stream.of(
          Arguments.of(
              createStatusModelWithNiederschrift(null),
              null,
