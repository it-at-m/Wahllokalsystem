...
class SchnellmeldungDruckuhrzeitSenderTest {
  ...
  @InjectMocks SchnellmeldungDruckuhrzeitSender unitUnderTest;
  ...
  class SubmitStatus {
    ...
    void should_callStatusClientPostSchnellmeldungDruckuhrzeit_when_requirementsAreMet(
    ...
    void should_notCallStatusClientPostSchnellmeldungDruckuhrzeit_when_requirementsAreNotMet(
        final ArgumentsAccessor arguments) {
      val id = new BezirkUndWahlID();
      val newStatus = arguments.get(0, StatusModel.class);
      val oldStatus = arguments.get(1, StatusModel.class);
