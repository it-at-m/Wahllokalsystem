...
class WahlscheineServiceSecurityTest {
  ...
  @Autowired WahlscheineService unitUnderTest;
  ...
  class GetWahlscheine {
    ...
    private static Stream<Arguments> getMissingAuthoritiesVariations() {
      return SecurityUtils.buildArgumentsForMissingAuthoritiesVariations(
          Authorities.ALL_AUTHORITIES_GET_WAHLSCHEINE);
    }
  }
  ...
  class SetWahlscheine {
    ...
    void should_getAccess_when_allRequiredAuthoritiesArePresent() {
      ...
      Assertions.assertThatNoException()
          .isThrownBy(() -> unitUnderTest.setWahlscheine(id, newWahlscheine));
    }
    ...
    void
      ...
      Assertions.assertThatException()
          .isThrownBy(() -> unitUnderTest.setWahlscheine(id, wahlscheineModel))
          .isInstanceOf(AccessDeniedException.class);
    }
