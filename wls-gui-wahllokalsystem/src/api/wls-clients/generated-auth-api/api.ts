 ...
 *
 * The version of the OpenAPI document: 0.7.12-SNAPSHOT
...
export const AuthServerControllerApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         */
        getLogoutUrl: async (options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
            const localVarPath = `/authserver/logouturl`;
...
export const AuthServerControllerApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async getLogoutUrl(options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<ResolvedUrlDTO>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.getLogoutUrl(options);
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
            const localVarOperationServerBasePath = operationServerMap['AuthServerControllerApi.getLogoutUrl']?.[localVarOperationServerIndex]?.url;
...
export const AuthServerControllerApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        getLogoutUrl(options?: RawAxiosRequestConfig): AxiosPromise<ResolvedUrlDTO> {
            return localVarFp.getLogoutUrl(options).then((request) => request(axios, basePath));
        },
    };
};
...
export const RolesControllerApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        getRoleMappings: async (options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
            const localVarPath = `/roles/mappings`;
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
            const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL);
            let baseOptions;
            if (configuration) {
...
export const RolesControllerApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async getRoleMappings(options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<RoleMappingsDTO>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.getRoleMappings(options);
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
            const localVarOperationServerBasePath = operationServerMap['RolesControllerApi.getRoleMappings']?.[localVarOperationServerIndex]?.url;
            return (axios, basePath) => createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration)(axios, localVarOperationServerBasePath || basePath);
        },
    }
};
...
export const RolesControllerApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        getRoleMappings(options?: RawAxiosRequestConfig): AxiosPromise<RoleMappingsDTO> {
            return localVarFp.getRoleMappings(options).then((request) => request(axios, basePath));
        },
    };
};
