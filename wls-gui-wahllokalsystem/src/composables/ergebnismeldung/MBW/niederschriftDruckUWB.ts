...
export function useNiederschriftDruckUWB() {
  function gatherData(
    data: NiederschriftDruckInputBWB | NiederschriftDruckInputUWB
  ) {
    return `
            <!DOCTYPE html>
            <html lang="de">
            ...
            <!-- Title -->
            <div class="width_100 textAlignCenter marginTop_1_15"><span class="bold fontSize_11">V1 MigBW</span></div>
