...
import { useStimmzettelerfassungTeamStatusUtils } from "@/composables/dse/teamStatus/stimmzettelerfassungTeamStatusUtils.ts";
...
vi.mock(
  import("@/composables/dse/teamStatus/stimmzettelerfassungTeamStatusService.ts"),
