    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        http
                .authorizeHttpRequests((requests) -> requests.requestMatchers(
                        ...
                        PathPatternRequestMatcher.withDefaults().matcher("/businessActions/loginCheck/**"),
                        PathPatternRequestMatcher.withDefaults().matcher("/businessActions/konfigurationUnauthorized/**"))
                        .permitAll())
                .authorizeHttpRequests((requests) -> requests.requestMatchers("/**")
                        .authenticated())
