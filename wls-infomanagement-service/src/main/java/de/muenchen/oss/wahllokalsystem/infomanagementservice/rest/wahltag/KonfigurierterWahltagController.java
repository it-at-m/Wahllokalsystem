...
public class KonfigurierterWahltagController {
  ...
  @Operation(
      ...
      responses = {
        @ApiResponse(
            responseCode = "200",
            description = "Konfigurierter Wahltag erfolgreich zurückgegeben."),
  ...
  public ResponseEntity<KonfigurierterWahltagDTO> getKonfigurierterWahltag() {
    val konfigurierterWahltagDTO =
        mapper.toDTO(konfigurierterWahltagService.getKonfigurierterWahltag());
  ...
  @Operation(
      ...
      responses = {
        @ApiResponse(
            responseCode = "200",
            description = "Konfigurierter Wahltag erfolgreich gespeichert."),
      })
  @PostMapping(value = KONFIGURIERTER_WAHLTAG_PATH)
  public void setKonfigurierterWahltag(
  ...
  @Operation(
      ...
      responses = {
        @ApiResponse(
            responseCode = "200",
            description = "Konfigurierter Wahltag erfolgreich gelöscht.")
      })
  ...
  @Operation(
      ...
      responses = {
        @ApiResponse(
            responseCode = "200",
            description = "Liste aller Konfigurierter Wahltage erfolgreich zurückgegeben."),
        @ApiResponse(responseCode = "204", description = "Kein Konfigurierter Wahltag vorhanden."),
      })
  @GetMapping(value = KONFIGURIERTE_WAHLTAGE_PATH)
  public ResponseEntity<List<KonfigurierterWahltagDTO>> getKonfigurierteWahltage() {
    List<KonfigurierterWahltagDTO> konfigurierteWahltageDTO =
        mapper.toDTOList(konfigurierterWahltagService.getKonfigurierteWahltage());
  ...
  @Operation(
      ...
      responses = {
        @ApiResponse(
            responseCode = "200",
            description = "Erfolgreiche Rückmeldung ob Wahltag aktiv ist ."),
