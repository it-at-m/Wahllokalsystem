...
public interface KonfigurationModelMapper {
  ...
  Map<KonfigurationKonfigKey, Map<WahlbezirkArt, KonfigurationKonfigKey>> alternativeKeys =
      Map.of(
          KonfigurationKonfigKey.FRUEHESTE_EROEFFNUNGSZEIT,
          Map.of(
              WahlbezirkArt.UWB,
              KonfigurationKonfigKey.FRUEHESTE_EROEFFNUNGSZEIT_UW,
              WahlbezirkArt.BWB,
              KonfigurationKonfigKey.FRUEHESTE_EROEFFNUNGSZEIT_BW),
          KonfigurationKonfigKey.SPAETESTE_EROEFFNUNGSZEIT,
          Map.of(
              WahlbezirkArt.UWB,
              KonfigurationKonfigKey.SPAETESTE_EROEFFNUNGSZEIT_UW,
              WahlbezirkArt.BWB,
              KonfigurationKonfigKey.SPAETESTE_EROEFFNUNGSZEIT_BW),
          KonfigurationKonfigKey.FRUEHESTE_SCHLIESSUNGSZEIT,
          Map.of(
              WahlbezirkArt.UWB,
              KonfigurationKonfigKey.FRUEHESTE_EROEFFNUNGSZEIT_UW,
              WahlbezirkArt.BWB,
  ...
  default Optional<KonfigurationKonfigKey> getAlternativeKey(
      final KonfigurationKonfigKey konfigKey, final WahlbezirkArt wahlbezirkArt) {
  ...
  default KennbuchstabenListenModel toKennbuchstabenListenModel(
      final String kennbuchstabenListenAsString) {
    val stringSeparated =
        StringUtils.split(kennbuchstabenListenAsString, KENNBUCHSTABEN_LISTEN_SEPARATOR);
  ...
  default KennbuchstabenListeModel toKennbuchstabenListeModel(
      final String kennbuchstabenListeAsString) {
    val stringSeparated =
        StringUtils.split(kennbuchstabenListeAsString, KENNBUCHSTABEN_LISTE_SEPARATOR);
  ...
  default KennbuchstabenModel toKennbuchstabenModel(final String kennbuchstabenAsString) {
    return new KennbuchstabenModel(
        List.of(StringUtils.split(kennbuchstabenAsString, KENNBUCHSTABEN_SEPARATOR)));
  }
}
