...
class KonfigurierterWahltagModelMapperTest {
  ...
  private final KonfigurierterWahltagModelMapper unitUnderTest =
      Mappers.getMapper(KonfigurierterWahltagModelMapper.class);
  ...
  class ToModelList {
    ...
    void should_returnListOfKonfigurierterWahltagModel_when_listOfKonfigurierterWahltagIsGiven() {
      ...
      val entityListToMap =
          List.of(
              new KonfigurierterWahltag(wahltag1, wahltagID1, isActive1, nummer1),
      ...
      val expectedModelList =
          List.of(
              new KonfigurierterWahltagModel(wahltag1, wahltagID1, isActive1, nummer1),
      ...
      Assertions.assertThat(unitUnderTest.toModelList(entityListToMap))
          .isEqualTo(expectedModelList);
    }
  }
}
