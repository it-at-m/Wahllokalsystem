...
public class DummyClientImpl implements WaehleranzahlClient, WahllokalZustandClient {
  ...
  public void postWahlbeteiligung(WaehleranzahlModel waehleranzahlModel) throws WlsException {
    log.info(
        "Dummy client postWahlbeteiligung() called instead of EAI with: {}", waehleranzahlModel);
  }
  ...
  public void postSchnellmeldungSendungsuhrzeit(
      ...
      throws WlsException {
    log.info(
        "Dummy client postSchnellmeldungSendungsuhrzeit() called instead of EAI with: "
            + bezirkUndWahlID
  ...
  public void postSchnellmeldungDruckuhrzeit(
      ...
      throws WlsException {
    log.info(
        "Dummy client postSchnellmeldungDruckuhrzeit() called instead of EAI with: "
            + bezirkUndWahlID
  ...
  public void postNiederschriftSendungsuhrzeit(
      ...
      throws WlsException {
    log.info(
        "Dummy client postNiederschriftSendungsuhrzeit() called instead of EAI with: "
            + bezirkUndWahlID
  ...
  public void postNiederschriftDruckuhrzeit(
      ...
      throws WlsException {
    log.info(
        "Dummy client postNiederschriftDruckuhrzeit() called instead of EAI with: "
            + bezirkUndWahlID
