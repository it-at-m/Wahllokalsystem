...
public class WaehleranzahlController extends AbstractController {
  ...
  @Operation(
      ...
      responses = {
        @ApiResponse(
            responseCode = "200",
            description = "Wahlbeteiligung für Wahl erfolgreich zurückgegeben.")
      })
  @GetMapping("/{wahlID}/{wahlbezirkID}")
  public ResponseEntity<WaehleranzahlDTO> getWahlbeteiligung(
  ...
  @Operation(
      ...
      responses = {
        @ApiResponse(
            responseCode = "200",
            description = "Wahlbeteiligung für die Wahl erfolgreich gespeichert und zurückgegeben.")
      })
  @PostMapping("/{wahlID}/{wahlbezirkID}")
  public void postWahlbeteiligung(
      @PathVariable("wahlbezirkID") final String wahlbezirkID,
      @PathVariable("wahlID") final String wahlID,
      @RequestBody WaehleranzahlDTO waehleranzahl) {
    log.info("postWahlbeteiligung {}", wahlbezirkID);

    val waehleranzahlSetModel =
        waehleranzahlDTOMapper.toSetModel(new BezirkUndWahlID(wahlID, wahlbezirkID), waehleranzahl);
