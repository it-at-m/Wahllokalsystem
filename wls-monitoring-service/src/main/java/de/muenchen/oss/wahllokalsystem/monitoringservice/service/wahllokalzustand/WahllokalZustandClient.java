...
public interface WahllokalZustandClient {
   ...
   */
  void postLastSeen(final String wahlbezirkID, final LocalDateTime zuletztGesehen)
      throws WlsException;
   ...
   * @throws WlsException {@link TechnischeWlsException} if there were trouble during communication
   */
  void postLetzteAbmeldung(final String wahlbezirkID, final LocalDateTime letzteAbmeldung)
      throws WlsException;
   ...
   * @throws WlsException {@link TechnischeWlsException} if there were trouble during communication
   */
  void postSchnellmeldungSendungsuhrzeit(
   ...
   * @param schnellmeldungDruckuhrzeit the time this Data was created, the Schnellmeldung was
   *     printed
   * @throws WlsException {@link TechnischeWlsException} if there were trouble during communication
   */
  void postSchnellmeldungDruckuhrzeit(
   ...
   * @throws WlsException {@link TechnischeWlsException} if there were trouble during communication
   */
  void postNiederschriftSendungsuhrzeit(
   ...
   * @throws WlsException {@link TechnischeWlsException} if there were trouble during communication
   */
  void postNiederschriftDruckuhrzeit(
