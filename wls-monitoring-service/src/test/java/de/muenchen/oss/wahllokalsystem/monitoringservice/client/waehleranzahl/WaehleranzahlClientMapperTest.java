...
public class WaehleranzahlClientMapperTest {
  ...
  private final WaehleranzahlClientMapper unitUnderTest =
      Mappers.getMapper(WaehleranzahlClientMapper.class);
  ...
  class FromModelToRemoteClientDTO {
    ...
    void should_return_RemoteClientDTO_when_modelIsGiven() {
      ...
      val waehleranzahlModel =
          new WaehleranzahlModel(bezirkUndWahlID, anzahlWahler, meldeZeitpunkt);
