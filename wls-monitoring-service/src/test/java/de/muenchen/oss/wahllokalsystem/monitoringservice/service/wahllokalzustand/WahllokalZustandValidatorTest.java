  ...
  class ValidWahlbezirkIDOrThrow {
    ...
    void should_notThrowAnyException_when_wahlbezirkIdIsNotNullOrBlankOrEmpty() {
      Assertions.assertThatNoException()
          .isThrownBy(
              () ->
                  unitUnderTest.validWahlbezirkIDOrThrow(
                      "wahlbezirkID", mockedFachlicheWlsException));
    }
    ...
    void should_throwGivenException_when_wahlbezirkIdIsNull() {
      Assertions.assertThatException()
          .isThrownBy(
              () -> unitUnderTest.validWahlbezirkIDOrThrow(null, mockedFachlicheWlsException))
    ...
    void should_throwGivenException_when_wahlbezirkIdIsBlank() {
      Assertions.assertThatException()
          .isThrownBy(
              () -> unitUnderTest.validWahlbezirkIDOrThrow("   ", mockedFachlicheWlsException))
          .isSameAs(mockedFachlicheWlsException);
    }
    ...
    void should_throwGivenException_when_wahlbezirkIdIsEmpty() {
      Assertions.assertThatException()
          .isThrownBy(() -> unitUnderTest.validWahlbezirkIDOrThrow("", mockedFachlicheWlsException))
          .isSameAs(mockedFachlicheWlsException);
    }
  }
    ...
    void should_throwGivenException_when_paramBezirkUndWahlIdIsNull() {
      Assertions.assertThatException()
          .isThrownBy(
              () ->
                  unitUnderTest.validWahlIdUndWahlbezirkIDOrThrow(
                      null, mockedFachlicheWlsException))
          .isSameAs(mockedFachlicheWlsException);
    }
    ...
    void should_throwGivenException_when_wahlIdIsNull() {
      Assertions.assertThatException()
          .isThrownBy(
              () ->
                  unitUnderTest.validWahlIdUndWahlbezirkIDOrThrow(
                      new BezirkUndWahlID(null, "wahlbezirkID01"), mockedFachlicheWlsException))
          .isSameAs(mockedFachlicheWlsException);
    }
    ...
    void should_throwGivenException_when_wahlIdIsBlank() {
      Assertions.assertThatException()
          .isThrownBy(
              () ->
                  unitUnderTest.validWahlIdUndWahlbezirkIDOrThrow(
                      new BezirkUndWahlID("   ", "wahlbezirkID01"), mockedFachlicheWlsException))
          .isSameAs(mockedFachlicheWlsException);
    }
    ...
    void should_throwGivenException_when_wahlbezirkIdIsNull() {
      Assertions.assertThatException()
          .isThrownBy(
              () ->
                  unitUnderTest.validWahlIdUndWahlbezirkIDOrThrow(
                      new BezirkUndWahlID("wahlID01", null), mockedFachlicheWlsException))
          .isSameAs(mockedFachlicheWlsException);
    }
    ...
    void should_throwGivenException_when_wahlbezirkIdIsBlank() {
      Assertions.assertThatException()
          .isThrownBy(
              () ->
                  unitUnderTest.validWahlIdUndWahlbezirkIDOrThrow(
                      new BezirkUndWahlID("wahlID01", "   "), mockedFachlicheWlsException))
          .isSameAs(mockedFachlicheWlsException);
    }
