...
public enum AuthoritiesEnum {
  WLS_VORFAELLEUNDVORKOMMNISSE_SERVICE_READ_THEENTITY,
  WLS_VORFAELLEUNDVORKOMMNISSE_SERVICE_WRITE_THEENTITY,
  WLS_VORFAELLEUNDVORKOMMNISSE_SERVICE_DELETE_THEENTITY,
