...
public class EreignisseRepositoryTest {
    ...
    @Autowired
    EreignisseRepository unitUnderTest;
    ...
    class FindByWahlbezirkID {
        ...
        void should_findEreignisse_when_givenWahlbezirkID() {
            ...
            val ereignisList1 = Set.of(
                    TestdataFactory.CreateEreignisEntity.withData("beschreibung1"),
                    TestdataFactory.CreateEreignisEntity.withData("beschreibung2"));
            val ereignisList2 = Set.of(
                    TestdataFactory.CreateEreignisEntity.withData("beschreibung3"));
            val ereignisse1 = TestdataFactory.CreateEreignisseEntity.withData(wahlbezirkID1, ereignisList1);
            val ereignisse2 = TestdataFactory.CreateEreignisseEntity.withData(wahlbezirkID2, ereignisList2);
            ...
            Assertions.assertThat(result.get().getEreignisse()).noneMatch(ereignis -> ereignis.getBeschreibung().equals("beschreibung3"));
        }
    }
    ...
    class DeleteByWahlbezirkID {
        ...
        void should_deleteEreignisseWithMatchingWahlbezirkID_when_givenWahlbezirkID() {
            ...
            Assertions.assertThat(savedEreignisse.get().getEreignisse().size()).isEqualTo(ereignisList.size());
