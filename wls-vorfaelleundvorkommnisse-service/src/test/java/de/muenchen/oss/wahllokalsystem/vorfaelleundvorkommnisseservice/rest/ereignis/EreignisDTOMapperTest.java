...
class EreignisDTOMapperTest {
    ...
    void should_returnWahlbezirkEreignisseDTO_when_givenEreignisseModel() {
      ...
      val mockedEreignisseModel =
          TestdataFactory.CreateWahlbezirkEreignisseModel.withData(
              "wahlbezirkID", false, false, mockedListOfEreignisModel);
      val expectedEreignisseDTO =
  ...
  class ToModel {
    ...
    void should_returnEreignisseModel_when_givenEreignisseWriteDTO() {
      ...
      val mockedListOfEreignisDto =
          List.of(
              TestdataFactory.CreateEreignisDto.withData(),
              TestdataFactory.CreateEreignisDto.withData());
      val mockedEreignisseWriteDTO =
          TestdataFactory.CreateEreignisseWriteDto.withData(mockedListOfEreignisDto);
      val expectedEreignisModel =
