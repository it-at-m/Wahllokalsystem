...
class EreignisseModelMapperTest {
    ...
    private final EreignisseModelMapper unitUnderTest = Mappers.getMapper(EreignisseModelMapper.class);
    ...
    class ToEntity {
        ...
        void should_returnEreignisse_when_givenEreignisseModel() {
            ...
            val mockedEreignisseWriteModel = TestdataFactory.CreateEreignisseWriteModel.withData(wahlbezirkID, ereignisModelList);
