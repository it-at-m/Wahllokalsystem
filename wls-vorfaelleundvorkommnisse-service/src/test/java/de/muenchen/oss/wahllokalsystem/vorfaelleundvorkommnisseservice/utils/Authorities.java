...
public class Authorities {
    ...
    public static final String[] ALL_AUTHORITIES_GET_EREIGNISSE = ArrayUtils.addAll(ALL_REPO_AUTHORITIES_GET_EREIGNISSE,
    ...
    public static final String[] ALL_AUTHORITIES_SET_EREIGNISSE = ArrayUtils.addAll(ALL_REPO_AUTHORITIES_SET_EREIGNISSE,
            ALL_SERVICE_AUTHORITIES_SET_EREIGNISSE);
}
