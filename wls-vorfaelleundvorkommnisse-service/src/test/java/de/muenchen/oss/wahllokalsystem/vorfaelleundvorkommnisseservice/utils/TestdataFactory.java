...
public class TestdataFactory {
    ...
    public static EreignisModel createEreignisModelWithData(String wahlbezirkID, String beschreibung, LocalDateTime uhrzeit,
    ...
    public static EreignisDTO createEreignisDTOWithData(String wahlbezirkID, String beschreibung, LocalDateTime uhrzeit, Ereignisart ereignisart) {
    ...
    public static EreignisWriteDTO createEreignisWriteDTOWithData(String beschreibung, LocalDateTime uhrzeit, Ereignisart ereignisart) {
