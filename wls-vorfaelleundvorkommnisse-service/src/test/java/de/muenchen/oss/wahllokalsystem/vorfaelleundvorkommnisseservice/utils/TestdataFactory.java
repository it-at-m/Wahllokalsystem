...
public class TestdataFactory {
  ...
  public static class CreateEreignisEntity {
    ...
    public static List<Ereignis> listFromModel(EreignisseModel ereignisWriteModel) {
      List<Ereignis> ereignisList =
          ereignisWriteModel.ereigniseintraege().stream()
              .map(
                  ereignis ->
                      new Ereignis(
                          ereignis.beschreibung(),
                          ereignis.uhrzeit(),
                          MapEreignisart.ereignisartModelToEreignisart(ereignis.ereignisart())))
              .toList();
      return ereignisList;
    }
  }
  ...
  public static class CreateEreignisModel {
    ...
    public static EreignisModel withData(String beschreibung) {
      return new EreignisModel(
          beschreibung, LocalDateTime.now().withNano(0), EreignisartModel.VORFALL);
    }
    ...
    public static EreignisModel fromEntity(Ereignis ereignisEntity) {
      return new EreignisModel(
          ereignisEntity.getBeschreibung(),
          ereignisEntity.getUhrzeit(),
  ...
  public static class CreateWahlbezirkEreignisseModel {
    ...
    public static EreignisseModel withData(
        String wahlbezirkID,
        boolean keineVorfaelle,
        boolean keineVorkommnisse,
        List<EreignisModel> ereignisModelList) {
      return new EreignisseModel(
          wahlbezirkID, keineVorfaelle, keineVorkommnisse, ereignisModelList);
    }
  }
  ...
  public static class CreateEreignisseWriteModel {
    ...
    public static EreignisseModel withData(
        String wahlbezirkID, List<EreignisModel> ereignisModelList) {
      return new EreignisseModel(wahlbezirkID, true, true, ereignisModelList);
    }

    public static EreignisseModel fromDto(
        String wahlbezirkID, EreignisseWriteDTO ereignisseWriteDTO) {
      List<EreignisModel> ereignisModelList =
          ereignisseWriteDTO.ereigniseintraege().stream()
              .map(
                  ereignisDto ->
                      new EreignisModel(
                          ereignisDto.beschreibung(),
                          ereignisDto.uhrzeit(),
                          MapEreignisart.ereignisartDtoToEreignisartModel(
                              ereignisDto.ereignisart())))
              .toList();
      return new EreignisseModel(
          wahlbezirkID,
          ereignisseWriteDTO.keineVorfaelle(),
          ereignisseWriteDTO.keineVorkommnisse(),
          ereignisModelList);
    }
  }
  ...
  public static class CreateEreignisDto {
    public static EreignisDTO withData() {
      return new EreignisDTO(
          "beschreibung", LocalDateTime.now().withNano(0), EreignisartDTO.VORFALL);
    }
  }
  ...
  public static class CreateWahlbezirkEreignisseDto {
    public static WahlbezirkEreignisseDTO fromModel(EreignisseModel ereignisseModel) {
      List<EreignisDTO> ereignisDtoList =
          ereignisseModel.ereigniseintraege().stream()
              .map(
                  ereignisModel ->
                      new EreignisDTO(
                          ereignisModel.beschreibung(),
                          ereignisModel.uhrzeit(),
                          MapEreignisart.ereignisartModelToEreignisartDto(
                              ereignisModel.ereignisart())))
              .toList();
      return new WahlbezirkEreignisseDTO(
          ereignisseModel.wahlbezirkID(),
          ereignisseModel.keineVorfaelle(),
          ereignisseModel.keineVorkommnisse(),
          ereignisDtoList);
    }
  }
  ...
  public static class MapEreignisart {
    ...
    public static EreignisartDTO ereignisartModelToEreignisartDto(
        EreignisartModel ereignisartModel) {
      return switch (ereignisartModel) {
