...
import de.muenchen.oss.wahllokalsystem.wahlvorbereitungservice.configuration.nfcconverter.NfcRequestFilter;
...
public class UnicodeConfiguration {
  ...
  private static final String NFC_WHITE_LIST =
      "text/plain; application/json; application/hal+json; text/html";
