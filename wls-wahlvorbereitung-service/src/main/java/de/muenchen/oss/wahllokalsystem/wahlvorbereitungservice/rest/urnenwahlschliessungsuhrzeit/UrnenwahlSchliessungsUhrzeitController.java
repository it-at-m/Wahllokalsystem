...
public class UrnenwahlSchliessungsUhrzeitController extends AbstractController {
  ...
  @Operation(
      ...
      responses = {
        @ApiResponse(
            responseCode = "200",
            description = "Urnenwahlschliessungsuhrzeit erfolgreich zurückgegeben."),
        @ApiResponse(
            responseCode = "204",
  ...
  public ResponseEntity<UrnenwahlSchliessungsUhrzeitDTO> getUrnenwahlSchliessungsUhrzeit(
      @PathVariable("wahlbezirkID") final String wahlbezirkID) {
    val urnenwahlSchliessungsUhrzeitModel =
        urnenwahlSchliessungsUhrzeitService.getUrnenwahlSchliessungsUhrzeit(wahlbezirkID);

    return okWithBodyOrNoContent(
        urnenwahlSchliessungsUhrzeitModel.map(urnenwahlSchliessungsUhrzeitDTOMapper::toDTO));
  }
  ...
  @Operation(
      ...
      responses = {
        @ApiResponse(
            responseCode = "201",
            description = "Urnenwahlschliessungsuhrzeit erfolgreich gespeichert.")
      })
  @PostMapping("{wahlbezirkID}")
  @ResponseStatus(HttpStatus.CREATED)
  public void postUrnenwahlSchliessungsUhrzeit(
      @PathVariable("wahlbezirkID") final String wahlbezirkID,
      @RequestBody
          final UrnenwahlSchliessungsUhrzeitWriteDTO urnenwahlSchliessungsUhrzeitWriteDTO) {
    val urnenwahlSchliessungsUhrzeitToSet =
        urnenwahlSchliessungsUhrzeitDTOMapper.toModel(
            wahlbezirkID, urnenwahlSchliessungsUhrzeitWriteDTO);
    urnenwahlSchliessungsUhrzeitService.setUrnenwahlSchliessungsUhrzeit(
        urnenwahlSchliessungsUhrzeitToSet);
  }
}
