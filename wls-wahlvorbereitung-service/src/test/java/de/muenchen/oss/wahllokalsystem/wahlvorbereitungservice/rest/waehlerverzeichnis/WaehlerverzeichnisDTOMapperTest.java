...
class WaehlerverzeichnisDTOMapperTest {
  ...
  private final WaehlerverzeichnisDTOMapper unitUnderTest =
      Mappers.getMapper(WaehlerverzeichnisDTOMapper.class);
  ...
  class ToModel {
    ...
    void should_returnWaehlerverzeichnisModel_when_givenWaehlerverzeichnisDTO() {
      ...
      val expectedResult = new WaehlerverzeichnisModel(null, true, true, false, false);
      Assertions.assertThat(result).isEqualTo(expectedResult);
    }
