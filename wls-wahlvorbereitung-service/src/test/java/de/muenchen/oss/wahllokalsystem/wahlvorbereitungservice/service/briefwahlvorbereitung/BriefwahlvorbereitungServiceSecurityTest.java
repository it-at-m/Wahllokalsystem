...
public class BriefwahlvorbereitungServiceSecurityTest {

  @MockitoBean BezirkIDPermissionEvaluator bezirkIDPermissionEvaluator;

  @Autowired BriefwahlvorbereitungService unitUnderTest;
  ...
  class GetBriefwahlvorbereitung {
    ...
    private static Stream<Arguments> getAuthoritiesVariations() {
      return SecurityUtils.buildArgumentsForMissingAuthoritiesVariations(
          Authorities.ALL_AUTHORITIES_GET_BRIEFWAHLVORBEREITUNG);
    }
  }
  ...
  class SetBriefwahlvorbereitung {
    ...
    void should_notThrowException_when_givenAllAuthorities() {
      ...
      Assertions.assertThatNoException()
          .isThrownBy(() -> unitUnderTest.setBriefwahlvorbereitung(modelToSet));
    }
