...
class BriefwahlvorbereitungValidatorTest {
  ...
  @InjectMocks BriefwahlvorbereitungValidator unitUnderTest;
  ...
  class ValidModelToSetOrThrow {
    ...
    @Test
    void should_throwWlsException_when_anzahlUrnenIsNull() {
    ...
    @Test
    void should_throwWlsException_when_anzahlUrnenIsEmpty() {
    ...
    private BriefwahlvorbereitungModel.BriefwahlvorbereitungModelBuilder initValid() {
      ...
      return BriefwahlvorbereitungModel.builder()
          .wahlbezirkID("wahlbezirkID")
          .urnenAnzahl(urnenanzahl);
    }
  }
}
