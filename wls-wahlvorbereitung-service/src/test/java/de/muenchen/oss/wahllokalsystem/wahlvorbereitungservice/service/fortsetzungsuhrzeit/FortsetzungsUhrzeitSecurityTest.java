...
public class FortsetzungsUhrzeitSecurityTest {
    ...
    class GetFortsetzungsUhrzeit {
        ...
        @Test
        void accessGranted() {
            SecurityUtils.runAs(Authorities.ALL_AUTHORITIES_GET_FORTSETZUNGSUHRZEIT);
    ...
    class SetFortsetzungsUhrzeit {
        ...
        @Test
        void accessGranted() {
            SecurityUtils.runAs(Authorities.ALL_AUTHORITIES_POST_FORTSETZUNGSUHRZEIT);
        ...
        void accessDeniedOnServiceAuthorityMissing() {
            SecurityUtils.runAs(Authorities.ALL_AUTHORITIES_REPO_FORTSETZUNGSUHRZEIT);
