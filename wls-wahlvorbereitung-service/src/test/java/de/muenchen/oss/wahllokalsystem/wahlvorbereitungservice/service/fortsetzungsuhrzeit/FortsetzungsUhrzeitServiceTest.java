...
class FortsetzungsUhrzeitServiceTest {
  ...
  @Mock FortsetzungsUhrzeitRepository fortsetzungsUhrzeitRepository;

  @Mock FortsetzungsUhrzeitModelMapper fortsetzungsUhrzeitModelMapper;

  @Mock FortsetzungsUhrzeitValidator fortsetzungsUhrzeitValidator;

  @Mock ExceptionFactory exceptionFactory;

  @InjectMocks FortsetzungsUhrzeitService unitUnderTest;
  ...
  class GetFortsetzungsUhrzeit {
    ...
    void should_returnFortsetzungsuhrzeit_when_givenValidWahlbezirkID() {
      ...
      Mockito.when(fortsetzungsUhrzeitRepository.findById(wahlbezirkID))
          .thenReturn(Optional.of(mockedRepoResponse));
      Mockito.when(fortsetzungsUhrzeitModelMapper.toModel(mockedRepoResponse))
    ...
    void should_throwException_when_validationFailed() {
      ...
      Mockito.doThrow(mockedValidatorException)
          .when(fortsetzungsUhrzeitValidator)
          .validWahlbezirkIDOrThrow(wahlbezirkID);

      Assertions.assertThatException()
          .isThrownBy(() -> unitUnderTest.getFortsetzungsUhrzeit(wahlbezirkID))
  ...
  class SetFortsetzungsUhrzeit {
    ...
    void should_saveFortsetzungsuhrzeit_when_givenValidModel() {
      ...
      Mockito.when(fortsetzungsUhrzeitModelMapper.toEntity(modelToSave))
    ...
    void should_notSaveFortsetzungsuhrzeit_when_validationFailed() {
      ...
      Assertions.assertThatException()
          .isThrownBy(() -> unitUnderTest.setFortsetzungsUhrzeit(modelToSave))
    ...
    void should_throwTechnischeWlsException_when_savingFailed() {
      ...
      Mockito.doThrow(mockedSaveException)
          .when(fortsetzungsUhrzeitRepository)
