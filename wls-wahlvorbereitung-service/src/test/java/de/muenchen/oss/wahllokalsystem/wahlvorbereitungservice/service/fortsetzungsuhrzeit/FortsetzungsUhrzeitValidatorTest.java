...
class FortsetzungsUhrzeitValidatorTest {

  @Mock ExceptionFactory exceptionFactory;

  @InjectMocks FortsetzungsUhrzeitValidator unitUnderTest;
  ...
  class ValidModelToSetOrThrow {
    ...
    @Test
    void should_throwWlsException_when_fortsetzungsuhrzeitIsNull() {
      val invalidModel = initValid().fortsetzungsUhrzeit(null).build();
    ...
    private FortsetzungsUhrzeitModel.FortsetzungsUhrzeitModelBuilder initValid() {
      return FortsetzungsUhrzeitModel.builder()
          .wahlbezirkID("wahlbezirkID")
          .fortsetzungsUhrzeit(LocalDateTime.now());
    }
  }
}
