...
class UnterbrechungsUhrzeitServiceTest {
  ...
  @Mock UnterbrechungsUhrzeitRepository unterbrechungsUhrzeitRepository;

  @Mock UnterbrechungsUhrzeitModelMapper unterbrechungsUhrzeitModelMapper;

  @Mock UnterbrechungsUhrzeitValidator unterbrechungsUhrzeitValidator;

  @Mock ExceptionFactory exceptionFactory;

  @InjectMocks UnterbrechungsUhrzeitService unitUnderTest;
  ...
  class GetUnterbrechungsUhrzeit {
    ...
    void should_returnUnterbrechungsuhrzeit_when_givenValidWahlbezirkID() {
      ...
      Mockito.doNothing()
          .when(unterbrechungsUhrzeitValidator)
          .validWahlbezirkIDOrThrow(wahlbezirkID);
      Mockito.when(unterbrechungsUhrzeitRepository.findById(wahlbezirkID))
          .thenReturn(Optional.of(mockedRepoResponse));
      Mockito.when(unterbrechungsUhrzeitModelMapper.toModel(mockedRepoResponse))
  ...
  class SetUnterbrechungsUhrzeit {
    ...
    void should_saveUnterbrechungsuhrzeit_when_givenValidModel() {
      ...
      Mockito.when(unterbrechungsUhrzeitModelMapper.toEntity(modelToSave))
    ...
    void should_notSaveUnterbrechungsuhrzeit_when_validationFails() {
      ...
      Assertions.assertThatException()
          .isThrownBy(() -> unitUnderTest.setUnterbrechungsUhrzeit(modelToSave))
    ...
    void should_throwTechnischeWlsException_when_savingFailed() {
      ...
      Mockito.doThrow(mockedSaveException)
          .when(unterbrechungsUhrzeitRepository)
