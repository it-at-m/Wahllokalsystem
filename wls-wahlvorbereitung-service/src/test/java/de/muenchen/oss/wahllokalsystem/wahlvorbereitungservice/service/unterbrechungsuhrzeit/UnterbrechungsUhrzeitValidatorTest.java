...
class UnterbrechungsUhrzeitValidatorTest {

  @Mock ExceptionFactory exceptionFactory;

  @InjectMocks UnterbrechungsUhrzeitValidator unitUnderTest;
  ...
  class ValidModelToSetOrThrow {
    ...
    @Test
    void should_throwWlsException_when_unterbrechungsuhrzeitIsNull() {
      val invalidModel = initValid().unterbrechungsUhrzeit(null).build();
    ...
    private UnterbrechungsUhrzeitModel.UnterbrechungsUhrzeitModelBuilder initValid() {
      return UnterbrechungsUhrzeitModel.builder()
          .wahlbezirkID("wahlbezirkID")
          .unterbrechungsUhrzeit(LocalDateTime.now());
    }
  }
}
