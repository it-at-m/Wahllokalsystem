...
@SpringBootTest(
    classes = {WahlurneModelMapperImpl.class, UrnenwahlvorbereitungModelMapperImpl.class})
class UrnenwahlvorbereitungModelMapperTest {

  @Autowired private UrnenwahlvorbereitungModelMapper unitUnderTest;
    ...
    void should_returnUrnenwahlvorbereitungModel_when_givenUrnenwahlvorbereitungEntity() {
      ...
      val entityToMap =
          new UrnenwahlVorbereitung(
              wahlbezirkID, urnen, anzahlKabinen, anzahlTische, anzahlNebenraeume);

      val result = unitUnderTest.toModel(entityToMap);

      val expectedUrnen =
          List.of(new WahlurneModel("wahlID1", 3, true), new WahlurneModel("wahlID5", 17, false));
      val expecetedResult =
  ...
  class ToEntity {
    ...
    void should_returnUrnenwahlvorbereitungEntity_when_givenUrnenwahlvorbereitungModel() {
      ...
      val modelToMap =
          new UrnenwahlvorbereitungModel(
              wahlbezirkID, anzahlKabinen, anzahlTische, anzahlNebenraeume, urnen);

      val result = unitUnderTest.toEntity(modelToMap);

      val expectedUrnen =
          List.of(new Wahlurne("wahlID1", 3, true), new Wahlurne("wahlID5", 17, false));
      val expectedResult =
          new UrnenwahlVorbereitung(
              wahlbezirkID, expectedUrnen, anzahlKabinen, anzahlTische, anzahlNebenraeume);
