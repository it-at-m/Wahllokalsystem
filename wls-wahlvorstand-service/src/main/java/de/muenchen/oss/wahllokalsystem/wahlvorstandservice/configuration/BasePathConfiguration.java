...
public class BasePathConfiguration {
  ...
  private final de.muenchen.oss.wahllokalsystem.wahlvorstandservice.eai.infomanagement.ApiClient
      infomanagementApiClient;
  private final de.muenchen.oss.wahllokalsystem.wahlvorstandservice.eai.basisdaten.ApiClient
      basisdatenApiClient;
