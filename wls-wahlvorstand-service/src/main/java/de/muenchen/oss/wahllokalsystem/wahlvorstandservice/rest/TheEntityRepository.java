 ...
 * </p>
 */
@PreAuthorize("hasAuthority(T(de.muenchen.oss.wahllokalsystem.wahlvorstandservice.security.AuthoritiesEnum).WLS_WAHLVORSTAND_SERVICE_READ_THEENTITY.name())")
public interface TheEntityRepository extends CrudRepository<TheEntity, UUID> { //NOSONAR
    ...
    @PreAuthorize(
            "hasAuthority(T(de.muenchen.oss.wahllokalsystem.wahlvorstandservice.security.AuthoritiesEnum).WLS_WAHLVORSTAND_SERVICE_WRITE_THEENTITY.name())"
    )
